...
VERGL : BigDecimal;
  ...
  VKV : BigDecimal;
        ...
        export const ZAHL10000 = new BigDecimal(10000);

    

export class Lohnsteuer2020Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  static readonly ZAHL10000 = ZAHL10000;


  public name = 'Lohnsteuer2020Big';
  public _inputs = {
    af : 1,
    AJAHR : 0,
    ALTER1 : 0,
  ...
  public _outputs = {
    ...
    VFRB : new BigDecimal(0),
    VFRBS1 : new BigDecimal(0),
    VFRBS2 : new BigDecimal(0),
  ...
  MPARA() {
     if (this._inputs.KRV < 2) {/**  &lt; = <  */
          ...
          if (this._inputs.KRV == 0) {
              ...
              this._internals.BBGRV = new BigDecimal(82800);  /**  Neu 2020  */
            
            } else {
              this._internals.BBGRV = new BigDecimal(77400);  /**  Neu 2020  */
            
          }
          this._internals.RVSATZAN = BigDecimal.valueOf(0.093); /**  Neu 2019  */
          this._internals.TBSVORV = BigDecimal.valueOf(0.8);  /**  Neu 2020  */
         ...
         this._internals.BBGKVPV = new BigDecimal(56250); /**  Neu 2020  */
         this._internals.bd = new BigDecimal(2);/**  Neu 2019  */
        this._internals.KVSATZAN = (this._inputs.KVZ.divide(this._internals.bd).divide(ZAHL100)).add(BigDecimal.valueOf(0.07));/**  Neu 2019  */
        this._internals.KVSATZAG = BigDecimal.valueOf(0.0055+0.07);/**  Neu 2020  */
        
        if (this._inputs.PVS == 1) {
          
            this._internals.PVSATZAN = BigDecimal.valueOf(0.02025); /**  Neu 2019  */
            this._internals.PVSATZAG = BigDecimal.valueOf(0.01025); /**  Neu 2019  */
          
          } else {
            this._internals.PVSATZAN =  BigDecimal.valueOf(0.01525); /**  Neu 2019  */
            this._internals.PVSATZAG =  BigDecimal.valueOf(0.01525); /**  Neu 2019  */
        ...
        if (this._inputs.PVZ == 1) {
         ...
         /**  Anfang Neu 2020  */ 
         this._internals.W1STKL5 = new BigDecimal(10898);
         this._internals.W2STKL5 = new BigDecimal(28526);
         this._internals.W3STKL5 = new BigDecimal(216400);
         this._internals.GFB = new BigDecimal(9408);
          /**  Ende Neu 2020  */
         this._internals.SOLZFREI = new BigDecimal(972);
  ...
  MBERECH() { 
    ...
    this.MZTABFB(); 
    this._outputs.VFRB = ((this._internals.ANP.add(this._internals.FVB.add(this._internals.FVBZ))).multiply(ZAHL100)).setScale(0, BigDecimal.ROUND_DOWN);
    this.MLSTJAHR();
    
    this._outputs.WVFRB = ((this._internals.ZVE.subtract(this._internals.GFB)).multiply(ZAHL100)).setScale(0, BigDecimal.ROUND_DOWN); 
    if (this._outputs.WVFRB.compareTo(BigDecimal.ZERO()) == -1) {  /**  this._outputs.WVFRB < 0  */
       
        this._outputs.WVFRB = BigDecimal.valueOf(0); 
...
/**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 21  */
  MZTABFB() { 
    ...
    if (this._inputs.STKL == 1) {
        ...
        this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (7812))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neu 2020  */
      ...
      if (this._inputs.STKL == 2) {
          ...
          if (this._inputs.STKL == 3) {
                ...
                if (this._inputs.STKL == 4) {
                    ...
                    this._internals.SAP= BigDecimal.valueOf (36);
                    this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (3906))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neu 2020  */
  ...
  MSOLZ() {
    this._internals.SOLZFREI = (this._internals.SOLZFREI.multiply(BigDecimal.valueOf(this._internals.KZTAB))); 
  ...
  MSONST() {
    ...
    if (this._inputs.SONSTB.compareTo (BigDecimal.ZERO()) == 0) {
        ...
        this.MLSTJAHR();
         ...
         this._outputs.WVFRBM = (this._internals.ZVE.subtract(this._internals.GFB)).multiply(ZAHL100).setScale(2,BigDecimal.ROUND_DOWN);
         if (this._outputs.WVFRBM.compareTo(BigDecimal.ZERO()) == -1) { /**  this._outputs.WVFRBM < 0  */
          
            this._outputs.WVFRBM = BigDecimal.ZERO();
  ...
  MOSONST() {
    ...
    this.MZTABFB(); 
    this._outputs.VFRBS1 = ((this._internals.ANP.add(this._internals.FVB.add(this._internals.FVBZ))).multiply(ZAHL100)).setScale(2,BigDecimal.ROUND_DOWN);
    this.MLSTJAHR();
    
     this._outputs.WVFRBO = ((this._internals.ZVE.subtract(this._internals.GFB)).multiply(ZAHL100)).setScale(2, BigDecimal.ROUND_DOWN);
     if (this._outputs.WVFRBO.compareTo(BigDecimal.ZERO()) == -1 ) {
       
              this._outputs.WVFRBO = BigDecimal.ZERO();
  ...
  MRE4SONST() {
    ...
    this.MZTABFB(); 
    this._outputs.VFRBS2 = ((((this._internals.ANP.add(this._internals.FVB).add(this._internals.FVBZ))).multiply(ZAHL100))).subtract(this._outputs.VFRBS1);
  }
  
  /**  Komplett Neu 2020  */
     /**  Tarifliche Einkommensteuer §32a EStG, PAP Seite 36  */
  UPTAB20() {
    if (this._internals.X.compareTo(this._internals.GFB.add(ZAHL1)) == -1) { 
      
        this._internals.ST= BigDecimal.ZERO();
      
      } else {
        if (this._internals.X.compareTo (BigDecimal.valueOf (14533)) == -1) {/**  neu seit 2020  */
          
            this._internals.Y = (this._internals.X.subtract(this._internals.GFB)).divide(ZAHL10000, 6,BigDecimal.ROUND_DOWN); 
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (972.87)); /**  neu seit 2020  */
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (57052)) == -1) {/**  neu seit 2020  */
              
                this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (14532))).divide (ZAHL10000, 6, BigDecimal.ROUND_DOWN);
                this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (212.02));/**  neu seit 2020  */
                ...
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (972.79))).setScale (0, BigDecimal.ROUND_DOWN); /**  neu seit 2020  */
              
              } else {
              if (this._internals.X.compareTo (BigDecimal.valueOf (270501)) == -1) {/**  neu seit 2020  */
                
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (8963.74))).setScale (0, BigDecimal.ROUND_DOWN); /**  neu seit 2020  */
                  
                  } else {
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (17078.74))).setScale (0, BigDecimal.ROUND_DOWN); /**  neu seit 2020  */
