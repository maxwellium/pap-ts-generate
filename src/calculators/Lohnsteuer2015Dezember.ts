...
export class Lohnsteuer2015DezemberBig extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  public name = 'Lohnsteuer2015DezemberBig';
  public _inputs = {
    af : 1.0,
    AJAHR : 0,
    ALTER1 : 0,
  ...
  public _internals = {
    ...
    JW : new BigDecimal(0),
    JWLSTA : new BigDecimal(0),
    JWLSTN : new BigDecimal(0),
    JWSOLZA : new BigDecimal(0),
    JWSOLZN : new BigDecimal(0),
    JWBKA : new BigDecimal(0),
    JWBKN : new BigDecimal(0),
    K : 0,
    KENNVMT : 0,
  ...
  main() {
    ...
    this._internals.W1STKL5 = BigDecimal.valueOf(9873);
  ...
  MPARA() {
     if (this._inputs.KRV < 2) {/**  &lt; = <  */
          ...
          if (this._inputs.KRV == 0) {
            ...
            this._internals.BBGRV = new BigDecimal(72600);
          
          } else {
            this._internals.BBGRV = new BigDecimal(62400);
          
          }
          this._internals.RVSATZAN = BigDecimal.valueOf(0.0935);
          this._internals.TBSVORV = BigDecimal.valueOf(0.60);
         ...
         this._internals.BBGKVPV = new BigDecimal(49500);
        this._internals.KVSATZAN = (this._inputs.KVZ.divide(ZAHL100)).add(BigDecimal.valueOf(0.07));
        this._internals.KVSATZAG = BigDecimal.valueOf(0.07);
        
        if (this._inputs.PVS == 1) {
          
            this._internals.PVSATZAN = BigDecimal.valueOf(0.01675);
            this._internals.PVSATZAG = BigDecimal.valueOf(0.00675);
          
          } else {
            this._internals.PVSATZAN =  BigDecimal.valueOf(0.01175);
            this._internals.PVSATZAG =  BigDecimal.valueOf(0.01175);
        ...
        if (this._inputs.PVZ == 1) {
         ...
         /**  Anfang Neu 2015  */ 
         this._internals.W1STKL5 = new BigDecimal(9763);
         this._internals.W2STKL5 = new BigDecimal(26441);
         this._internals.W3STKL5 = new BigDecimal(200584);
         /**  Ende Neu 2015  */
  }
  ...
  this.UPVKVLZZ();
   ...
   if (this._inputs.ZKF.compareTo(BigDecimal.ZERO()) == 1) {  /**  this._inputs.ZKF > 0  */
  ...
  MZTABFBA() { /**  Neu 2015 Nur Änderung an der Bezeichnung */
...
/**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 23  */
  MZTABFBN() { 
    ...
    if (this._inputs.STKL == 1) {
        ...
        this._internals.SAP= BigDecimal.valueOf (36);
        this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (7152))).setScale (0, BigDecimal.ROUND_DOWN);
      
    } else {
      if (this._inputs.STKL == 2) {
          
              this._internals.EFA= BigDecimal.valueOf (1908);
              this._internals.SAP= BigDecimal.valueOf (36);
              this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (7152))).setScale (0, BigDecimal.ROUND_DOWN);
          ...
          if (this._inputs.STKL == 3) {
                ...
                if (this._inputs.STKL == 4) {
                    ...
                    this._internals.SAP= BigDecimal.valueOf (36);
                    this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (3576))).setScale (0, BigDecimal.ROUND_DOWN);
    ...
    if (this._inputs.KRV > 1) {/**  &lt; = < &gt; = >  */
      ...
      /**  Neu 2015 Anfang  */
        if (this._internals.ZRE4VP.compareTo(this._internals.BBGRV) == 1) {
          ...
          this._internals.VSP1 = (this._internals.TBSVORV.multiply(this._internals.ZRE4VP)).setScale(2,BigDecimal.ROUND_DOWN);
          this._internals.VSP1 = (this._internals.VSP1.multiply(this._internals.RVSATZAN)).setScale(2,BigDecimal.ROUND_DOWN);
         /**  Neu 2015 Ende  */ 
  ...
  MST5_6() {
    ...
    if (this._internals.ZZX.compareTo(this._internals.W2STKL5) == 1) {
      ...
      if (this._internals.ZZX.compareTo (this._internals.W3STKL5) == 1) {
            ...
            this._internals.ST= (this._internals.ST.add ((this._internals.W3STKL5.subtract (this._internals.W2STKL5)).multiply (BigDecimal.valueOf (0.42)))).setScale (0, BigDecimal.ROUND_DOWN);
            this._internals.ST= (this._internals.ST.add ((this._internals.ZZX.subtract (this._internals.W3STKL5)).multiply (BigDecimal.valueOf (0.45)))).setScale (0, BigDecimal.ROUND_DOWN);
          
          } else {
            this._internals.ST= (this._internals.ST.add ((this._internals.ZZX.subtract (this._internals.W2STKL5)).multiply (BigDecimal.valueOf (0.42)))).setScale (0, BigDecimal.ROUND_DOWN);
        ...
        if (this._internals.ZZX.compareTo (this._internals.W1STKL5) == 1) { 
            ...
            this.UP5_6();
            this._internals.HOCH= (this._internals.ST.add ((this._internals.ZZX.subtract (this._internals.W1STKL5)).multiply (BigDecimal.valueOf (0.42)))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neuer Wert 2014  */
  ...
  MLST1215() {
     if (this._inputs.LZZ > 1) {
            ...
            this._internals.JW = (this._internals.JWLSTN.subtract(BigDecimal.valueOf(11).multiply((this._internals.JWLSTA.subtract(this._internals.JWLSTN))))).setScale(0, BigDecimal.ROUND_DOWN);
            
             if (this._internals.JW.compareTo(BigDecimal.ZERO()) == -1) { /**  this._internals.JW < 0  */
            
                this._internals.ANTEIL1 = BigDecimal.ZERO();
         ...
         this._outputs.LSTLZZ = this._internals.ANTEIL1;
           this._internals.JW = (this._internals.JWSOLZN.subtract(BigDecimal.valueOf(11).multiply(this._internals.JWSOLZA.subtract(this._internals.JWSOLZN)))).setScale(0, BigDecimal.ROUND_DOWN);
         ...
         this._outputs.SOLZLZZ = this._internals.ANTEIL1;
           this._internals.JW = (this._internals.JWBKN.subtract(BigDecimal.valueOf(11).multiply(this._internals.JWBKA.subtract(this._internals.JWBKN)))).setScale(0, BigDecimal.ROUND_DOWN);
  ...
  UPTAB14() {
    if (this._internals.X.compareTo (BigDecimal.valueOf (8355)) == -1) { 
        ...
        if (this._internals.X.compareTo (BigDecimal.valueOf (13470)) == -1) {
            ...
            this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (8354))).divide (BigDecimal.valueOf (10000), 6, BigDecimal.ROUND_DOWN); 
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (974.58)); 
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (52882)) == -1) {
                ...
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (971))).setScale (0, BigDecimal.ROUND_DOWN); 
  ...
  UPTAB15() {
    if (this._internals.X.compareTo (BigDecimal.valueOf (8473)) == -1) { 
        ...
        if (this._internals.X.compareTo (BigDecimal.valueOf (13470)) == -1) {
            ...
            this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (8472))).divide (BigDecimal.valueOf (10000), 6, BigDecimal.ROUND_DOWN); 
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (997.60)); 
            this._internals.RW= this._internals.RW.add (BigDecimal.valueOf (1400));
            this._internals.ST= (this._internals.RW.multiply (this._internals.Y)).setScale (0, BigDecimal.ROUND_DOWN);
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (52882)) == -1) {
                ...
                this._internals.RW= this._internals.RW.add (BigDecimal.valueOf (2397));
                this._internals.RW= this._internals.RW.multiply (this._internals.Y);
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (948.68))).setScale (0, BigDecimal.ROUND_DOWN); 
              
              } else {
              if (this._internals.X.compareTo (BigDecimal.valueOf (250731)) == -1) {
                
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (8261.29))).setScale (0, BigDecimal.ROUND_DOWN); 
                  
                  } else {
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (15783.19))).setScale (0, BigDecimal.ROUND_DOWN); 
