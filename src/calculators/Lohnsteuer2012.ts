...
VERGL : BigDecimal;
  ...
  VKVSONST : BigDecimal;
      ...
      export const RENTBEMESSUNGSGR_OST_2012 = new BigDecimal(57600);
      
      /**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
      export const RENTBEMESSUNGSGR_WEST = new BigDecimal(67200);

    

export class Lohnsteuer2012Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  static readonly RENTBEMESSUNGSGR_OST_2012 = RENTBEMESSUNGSGR_OST_2012;
  static readonly RENTBEMESSUNGSGR_WEST = RENTBEMESSUNGSGR_WEST;


  public name = 'Lohnsteuer2012Big';
  public _inputs = {
    af : 1.0,
    AJAHR : 0,
    ALTER1 : 0,
    ...
    if (this._inputs.KRV > 1) {
        ...
        this._internals.VSP1= BigDecimal.ZERO();
            ...
            if (this._inputs.KRV == 0) {
                  ...
                  if (this._internals.ZRE4VP.compareTo(Lohnsteuer2012Big.RENTBEMESSUNGSGR_WEST) == 1) {
                    
                      this._internals.ZRE4VP = Lohnsteuer2012Big.RENTBEMESSUNGSGR_WEST;
                    
                  } 
              
            }        
             else {          
              if (this._internals.ZRE4VP.compareTo(Lohnsteuer2012Big.RENTBEMESSUNGSGR_OST_2012) == 1) {
                
                  this._internals.ZRE4VP = Lohnsteuer2012Big.RENTBEMESSUNGSGR_OST_2012;
                
              } 
            }
            
            this._internals.VSP1 = (this._internals.ZRE4VP.multiply(BigDecimal.valueOf(0.48))).setScale(2,BigDecimal.ROUND_DOWN);
            this._internals.VSP1 = (this._internals.VSP1.multiply(BigDecimal.valueOf(0.098))).setScale(2,BigDecimal.ROUND_DOWN);
  ...
  MVSP() {
    if (this._internals.ZRE4VP.compareTo( BigDecimal.valueOf(45900) ) == 1) {
      
      this._internals.ZRE4VP = BigDecimal.valueOf(45900);
  ...
  MSONST() {
    ...
    if (this._inputs.SONSTB.compareTo (BigDecimal.ZERO()) == 0) {
        ...
        this._internals.VKVSONST= BigDecimal.ZERO();
