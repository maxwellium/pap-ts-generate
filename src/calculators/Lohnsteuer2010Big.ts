...
export class Lohnsteuer2010Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  public _internals = {
    ...
    KVSATZAG : new BigDecimal(0).setScale(5),
    KVSATZAN : new BigDecimal(0).setScale(5),
    KZTAB : 0,
    ...
    PVSATZAG : new BigDecimal(0).setScale(5),
    PVSATZAN : new BigDecimal(0).setScale(5),
    RW : new BigDecimal(0),
    ...
    if (this._inputs.KRV > 1) {
        ...
        this._internals.VSP1= BigDecimal.ZERO();
            ...
            if (this._inputs.KRV == 0) {
              ...
              if (this._internals.ZRE4VP.compareTo (BigDecimal.valueOf (55800)) == 1) {
                
                  this._internals.ZRE4VP= BigDecimal.valueOf (55800);
                
              } 
            }
            
            this._internals.VSP1= (this._internals.ZRE4VP.multiply (BigDecimal.valueOf (0.4))).setScale (2, BigDecimal.ROUND_DOWN);
  ...
  MVSP() {
    if (this._internals.ZRE4VP.compareTo( BigDecimal.valueOf(45000) ) == 1) {
      
          this._internals.ZRE4VP = BigDecimal.valueOf(45000);
    ...
    if (this._inputs.PKV > 0) {
          ...
          if (this._inputs.STKL == 6) {
                ...
                if (this._inputs.PKV == 2) {
                      ...
                      this._internals.KVSATZAG = BigDecimal.valueOf(0.067).setScale(5);
        ...
        this._internals.KVSATZAN = BigDecimal.valueOf(0.076).setScale(5);
        if (this._inputs.PVS == 1) {
