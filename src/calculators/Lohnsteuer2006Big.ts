...
VERGL : BigDecimal;
        ...
        export const TAB1 = [0.0, 0.400, 0.384, 0.368, 0.352, 0.336, 0.320, 0.304, 0.288, 0.272, 0.256, 0.240, 0.224, 0.208, 0.192, 0.176, 0.160, 0.152, 0.144, 0.136, 0.128, 0.120, 0.112, 0.104, 0.096, 0.088, 0.080, 0.072, 0.064, 0.056, 0.048, 0.040, 0.032, 0.024, 0.016, 0.008, 0.000];

        /**  Tabelle fuer die Hoechstbetrage des Versorgungsfreibetrags  */
        export const TAB2 = [0, 3000, 2880, 2760, 2640, 2520, 2400, 2280, 2160, 2040, 1920, 1800, 1680, 1560, 1440, 1320, 1200, 1140, 1080, 1020, 960, 900, 840, 780, 720, 660, 600, 540, 480, 420, 360, 300, 240, 180, 120, 60, 0];

        /**  Tabelle fuer die Zuschlaege zum Versorgungsfreibetrag  */
        export const TAB3 = [0, 900, 864, 828, 792, 756, 720, 684, 648, 612, 576, 540, 504, 468, 432, 396, 360, 342, 324, 306, 288, 270, 252, 234, 216, 198, 180, 162, 144, 126, 108, 90, 72, 54, 36, 18, 0];

        /**  Tabelle fuer die Vomhundertsaetze des Altersentlastungsbetrags  */
        export const TAB4 = [0.0, 0.400, 0.384, 0.368, 0.352, 0.336, 0.320, 0.304, 0.288, 0.272, 0.256, 0.240, 0.224, 0.208, 0.192, 0.176, 0.160, 0.152, 0.144, 0.136, 0.128, 0.120, 0.112, 0.104, 0.096, 0.088, 0.080, 0.072, 0.064, 0.056, 0.048, 0.040, 0.032, 0.024, 0.016, 0.008, 0.000];

        /**  Tabelle fuer die Hoechstbetraege des Altersentlastungsbetrags  */
        export const TAB5 = [0, 1900, 1824, 1748, 1672, 1596, 1520, 1444, 1368, 1292, 1216, 1140, 1064, 988, 912, 836, 760, 722, 684, 646, 608, 570, 532, 494, 456, 418, 380, 342, 304, 266, 228, 190, 152, 114, 76, 38, 0];

        /**  Zahlenkonstanten fuer im Plan oft genutzte BigDecimal Werte  */
        export const ZAHL0 = new BigDecimal(0);
        export const ZAHL1 = new BigDecimal(1);
        ...
        export const ZAHL10 = new BigDecimal(10);
...
export class Lohnsteuer2006Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  public _internals = {
    ...
    main() {
        ...
        if (this._inputs.ZKF.compareTo(ZAHL0) == 1) {
    ...
    MRE4LZZ() {
        if (this._inputs.VBEZ.compareTo(ZAHL0) == 0) {      
        
            this._internals.FVBZ = ZAHL0;
            this._internals.FVB = ZAHL0;
            ...
            if (this._inputs.LZZ == 1) {
                ...
                if (((this._inputs.STERBE.add(this._inputs.VKAPA)).compareTo(ZAHL0)) == 1) {
                
                    this._internals.VBEZB = (this._inputs.VBEZM.multiply(BigDecimal.valueOf(this._inputs.ZMVB))).add(this._inputs.VBEZS);  
                    this._internals.HFVB = BigDecimal.valueOf(TAB2[this._internals.J] * 100);
                    this._internals.FVBZ = BigDecimal.valueOf(TAB3[this._internals.J]);
                
                } else {
                     this._internals.VBEZB = (this._inputs.VBEZM.multiply(BigDecimal.valueOf(this._inputs.ZMVB))).add(this._inputs.VBEZS);  
                     this._internals.HFVB = BigDecimal.valueOf(TAB2[this._internals.J] / 12 * this._inputs.ZMVB * 100);
                     this._internals.FVBZ = (BigDecimal.valueOf(TAB3[this._internals.J] / 12 * this._inputs.ZMVB)).setScale(0, BigDecimal.ROUND_UP);
            ...
            this._internals.FVB = (this._internals.VBEZB.multiply(BigDecimal.valueOf(TAB1[this._internals.J]))).setScale(0, BigDecimal.ROUND_UP);
        ...
        if (this._inputs.ALTER1 == 0) {
            ...
            this._internals.ALTE = (this._internals.BMG.multiply(BigDecimal.valueOf(TAB4[this._internals.K]))).setScale(0, BigDecimal.ROUND_UP);
            this._internals.JW = BigDecimal.valueOf(TAB5[this._internals.K] * 100);
            this.UPANTEIL();
    ...
    MRE4() {
        ...
        if (this._inputs.LZZ == 1) {
            ...
            if (this._inputs.LZZ == 2) {
                ...
                if (this._inputs.LZZ == 3) {
                    ...
                    this._internals.ZRE4 = ((this._internals.RE4LZZ.add(BigDecimal.valueOf(0.89))).multiply(BigDecimal.valueOf(3.6/7.0))).setScale(2, BigDecimal.ROUND_DOWN);
                    this._internals.ZRE4VP = ((this._internals.RE4LZZV.add(BigDecimal.valueOf(0.89))).multiply(BigDecimal.valueOf(3.6/7.0))).setScale(2, BigDecimal.ROUND_DOWN);
                    this._internals.ZVBEZ = ((this._inputs.VBEZ.subtract(this._internals.FVB).add(BigDecimal.valueOf(0.89))).multiply(BigDecimal.valueOf(3.6/7.0))).setScale(2, BigDecimal.ROUND_DOWN);
        ...
        if (this._internals.ZRE4.compareTo(ZAHL0) == -1) {
        
            this._internals.ZRE4 = ZAHL0;
        
        } else {
        
        }

        if (this._internals.ZVBEZ.compareTo(ZAHL0) == -1) {
        
            this._internals.ZVBEZ = ZAHL0;
    ...
    MLSTJAHR() {
        ...
        if (this._internals.ZVE.compareTo(ZAHL1) == -1) {
            ...
            this._internals.ZVE = ZAHL0;
            this._internals.X = ZAHL0;
    ...
    UPEVP() {
        ...
        this._internals.VSP1 = (this._internals.ZRE4VP.multiply(BigDecimal.valueOf(0.24))).setScale(2, BigDecimal.ROUND_DOWN);
        this._internals.VSP1 = (this._internals.VSP1.multiply(BigDecimal.valueOf(0.0975))).setScale(2, BigDecimal.ROUND_DOWN);

        
        }

        this._internals.VSP2 = this._internals.ZRE4VP.multiply(BigDecimal.valueOf(0.11));
        this._internals.VHB = BigDecimal.valueOf(1500 * this._internals.KZTAB);
    ...
    MVSP() {
        ...
        this._internals.VSPVOR = BigDecimal.valueOf(this._internals.KZTAB * 3068);
        this._internals.VSPMAX1 = BigDecimal.valueOf(this._internals.KZTAB * 1334);
        this._internals.VSPMAX2 = BigDecimal.valueOf(this._internals.KZTAB * 667);
        this._internals.VSPKURZ = BigDecimal.valueOf(this._internals.KZTAB * 1134);
        ...
        if (this._inputs.KRV == 1) {
            ...
            if (this._internals.VSPO.compareTo(this._internals.VSPKURZ) == 1) {
                ...
                this._internals.VSP = this._internals.VSPO.setScale(2, BigDecimal.ROUND_UP);
    ...
    UMVSP() {
        ...
        if (this._internals.VSPVOR.compareTo(ZAHL0) == -1) {
        
            this._internals.VSPVOR = ZAHL0;
        ...
        if (this._internals.VSPO.compareTo(this._internals.VSPVOR) == 1) {
            ...
            if (this._internals.VSPREST.compareTo(this._internals.VSPMAX1) == 1) {
                ...
                if (this._internals.VSPREST.compareTo(this._internals.VSPMAX2) == 1) {
                    ...
                    this._internals.VSP = (this._internals.VSP.add(this._internals.VSPMAX2)).setScale(0, BigDecimal.ROUND_UP);
                
                } else {
                    this._internals.VSP = (this._internals.VSP.add(this._internals.VSPREST)).setScale(0, BigDecimal.ROUND_UP);
            ...
            this._internals.VSP = this._internals.VSPO.setScale(0, BigDecimal.ROUND_UP);
    ...
    MSOLZ() {
        ...
        if (this._internals.JBMG.compareTo(this._internals.SOLZFREI) == 1) {
            ...
            this._internals.SOLZJ = (this._internals.JBMG.multiply(BigDecimal.valueOf(5.5/100))).setScale(2, BigDecimal.ROUND_DOWN);
            this._internals.SOLZMIN = (this._internals.JBMG.subtract(this._internals.SOLZFREI)).multiply(BigDecimal.valueOf(20.0/100.0));
    ...
    MSONST() {
        ...
        if (this._inputs.SONSTB.compareTo(ZAHL0) == 1) {
            ...
            if (this._inputs.R > 0) {
                ...
                this._outputs.BKS = ZAHL0;
            
            }
        
        } else {
            this._outputs.STS = ZAHL0;
            this._outputs.SOLZS = ZAHL0;
            this._outputs.BKS = ZAHL0;
    ...
    MVMT() {
        ...
        if ((this._inputs.VMT.add(this._inputs.VKAPA)).compareTo(ZAHL0) == 1) {
            ...
            if ((this._inputs.RE4.subtract(this._inputs.JFREIB).add(this._inputs.JHINZU)).compareTo(ZAHL0) == -1) {
            
                this._inputs.RE4 = this._inputs.RE4.subtract(this._inputs.JFREIB).add(this._inputs.JHINZU);
                this._inputs.JFREIB = ZAHL0;
                this._inputs.JHINZU = ZAHL0;
            ...
            if (this._inputs.R > 0) {
                ...
                this._outputs.BKV = ZAHL0;
            
            }
        
        } else {
            this._outputs.STV = ZAHL0;
            this._outputs.SOLZV = ZAHL0;
            this._outputs.BKV = ZAHL0;
