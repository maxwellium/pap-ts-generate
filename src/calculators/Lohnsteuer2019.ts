...
export class Lohnsteuer2019Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  MPARA() {
     if (this._inputs.KRV < 2) {/**  &lt; = <  */
          ...
          if (this._inputs.KRV == 0) {
              ...
              this._internals.BBGRV = new BigDecimal(80400);  /**  Neu 2019  */
            
            } else {
              this._internals.BBGRV = new BigDecimal(73800);  /**  Neu 2019  */
            
          }
          this._internals.RVSATZAN = BigDecimal.valueOf(0.093); /**  Neu 2019  */
          this._internals.TBSVORV = BigDecimal.valueOf(0.76);  /**  Neu 2019  */
         ...
         this._internals.BBGKVPV = new BigDecimal(54450); /**  Neu 2019  */
        ...
        this._internals.KVSATZAG = BigDecimal.valueOf(0.0045+0.07);/**  Neu 2019  */
        ...
        if (this._inputs.PVZ == 1) {
         ...
         /**  Anfang Neu 2019  */ 
         this._internals.W1STKL5 = new BigDecimal(10635);
         this._internals.W2STKL5 = new BigDecimal(27980);
         this._internals.W3STKL5 = new BigDecimal(212261);
         this._internals.GFB = new BigDecimal(9168);
          /**  Ende Neu 2019  */
...
/**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 21  */
  MZTABFB() { 
    ...
    if (this._inputs.STKL == 1) {
        ...
        this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (7620))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neu 2019  */
      ...
      if (this._inputs.STKL == 2) {
          ...
          if (this._inputs.STKL == 3) {
                ...
                if (this._inputs.STKL == 4) {
                    ...
                    this._internals.SAP= BigDecimal.valueOf (36);
                    this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (3810))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neu 2019  */
  ...
  UPTAB19() {
    if (this._internals.X.compareTo(this._internals.GFB.add(ZAHL1)) == -1) { 
        ...
        if (this._internals.X.compareTo (BigDecimal.valueOf (14255)) == -1) {
          
            this._internals.Y = (this._internals.X.subtract(this._internals.GFB)).divide(ZAHL10000, 6,BigDecimal.ROUND_DOWN); 
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (980.14)); 
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (55961)) == -1) {
              
                this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (14254))).divide (ZAHL10000, 6, BigDecimal.ROUND_DOWN);
                this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (216.16));
                ...
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (965.58))).setScale (0, BigDecimal.ROUND_DOWN); 
              
              } else {
              if (this._internals.X.compareTo (BigDecimal.valueOf (265327)) == -1) {
                
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (8780.9))).setScale (0, BigDecimal.ROUND_DOWN); 
                  
                  } else {
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (16740.68))).setScale (0, BigDecimal.ROUND_DOWN); 
