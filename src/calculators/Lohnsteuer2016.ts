...
export class Lohnsteuer2016Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  MPARA() {
     if (this._inputs.KRV < 2) {/**  &lt; = <  */
          ...
          if (this._inputs.KRV == 0) {
              ...
              this._internals.BBGRV = new BigDecimal(74400);  /**  Neu 2016  */
            
            } else {
              this._internals.BBGRV = new BigDecimal(64800);  /**  Neu 2016  */
            
          }
          this._internals.RVSATZAN = BigDecimal.valueOf(0.0935);
          this._internals.TBSVORV = BigDecimal.valueOf(0.64);  /**  Neu 2016  */
         ...
         this._internals.BBGKVPV = new BigDecimal(50850); /**  Neu 2016  */
        ...
        if (this._inputs.PVZ == 1) {
         ...
         /**  Anfang Neu 2016  */ 
         this._internals.W1STKL5 = new BigDecimal(10070);
         this._internals.W2STKL5 = new BigDecimal(26832);
         this._internals.W3STKL5 = new BigDecimal(203557);
         this._internals.GFB = new BigDecimal(8652);
  ...
  MBERECH() { 
    ...
    this.MZTABFB(); /**  Neu 2016  */
    this._outputs.VFRB = ((this._internals.ANP.add(this._internals.FVB.add(this._internals.FVBZ))).multiply(ZAHL100)).setScale(0, BigDecimal.ROUND_DOWN);/**  Neu 2016  */
    this.MLSTJAHR();
...
/**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 21  */
  MZTABFB() { 
    ...
    if (this._inputs.STKL == 1) {
        ...
        this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (7248))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neu 2016  */
      ...
      if (this._inputs.STKL == 2) {
          ...
          if (this._inputs.STKL == 3) {
                ...
                if (this._inputs.STKL == 4) {
                    ...
                    this._internals.SAP= BigDecimal.valueOf (36);
                    this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (3624))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neu 2016  */
  ...
  MSOLZ() {
    this._internals.SOLZFREI = (this._internals.SOLZFREI.multiply(BigDecimal.valueOf(this._internals.KZTAB))); /**  Neu 2016  */
  ...
  UPTAB16() {
    if (this._internals.X.compareTo(this._internals.GFB.add(ZAHL1)) == -1) { 
        ...
        if (this._internals.X.compareTo (BigDecimal.valueOf (13670)) == -1) {
          
            this._internals.Y = (this._internals.X.subtract(this._internals.GFB)).divide(ZAHL10000, 6,BigDecimal.ROUND_DOWN); 
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (993.62)); 
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (53666)) == -1) {
              
                this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (13669))).divide (ZAHL10000, 6, BigDecimal.ROUND_DOWN);
                this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (225.40));
                ...
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (952.48))).setScale (0, BigDecimal.ROUND_DOWN); 
              
              } else {
              if (this._internals.X.compareTo (BigDecimal.valueOf (254447)) == -1) {
                
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (8394.14))).setScale (0, BigDecimal.ROUND_DOWN); 
                  
                  } else {
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (16027.52))).setScale (0, BigDecimal.ROUND_DOWN); 
