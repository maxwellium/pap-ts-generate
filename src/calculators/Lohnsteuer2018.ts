...
export class Lohnsteuer2018Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  MPARA() {
     if (this._inputs.KRV < 2) {/**  &lt; = <  */
          ...
          if (this._inputs.KRV == 0) {
              ...
              this._internals.BBGRV = new BigDecimal(78000);  /**  Neu 2018  */
            
            } else {
              this._internals.BBGRV = new BigDecimal(69600);  /**  Neu 2018  */
            
          }
          this._internals.RVSATZAN = BigDecimal.valueOf(0.093); /**  Neu 2018  */
          this._internals.TBSVORV = BigDecimal.valueOf(0.72);  /**  Neu 2018  */
         ...
         this._internals.BBGKVPV = new BigDecimal(53100); /**  Neu 2018  */
        ...
        if (this._inputs.PVS == 1) {
            ...
            this._internals.PVSATZAN = BigDecimal.valueOf(0.01775); 
            this._internals.PVSATZAG = BigDecimal.valueOf(0.00775); 
          
          } else {
            this._internals.PVSATZAN =  BigDecimal.valueOf(0.01275); 
            this._internals.PVSATZAG =  BigDecimal.valueOf(0.01275); 
        ...
        if (this._inputs.PVZ == 1) {
         ...
         /**  Anfang Neu 2018  */ 
         this._internals.W1STKL5 = new BigDecimal(10440);
         this._internals.W2STKL5 = new BigDecimal(27475);
         this._internals.W3STKL5 = new BigDecimal(208426);
         this._internals.GFB = new BigDecimal(9000);
          /**  Ende Neu 2018  */
...
/**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 21  */
  MZTABFB() { 
    ...
    if (this._inputs.STKL == 1) {
        ...
        this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (7428))).setScale (0, BigDecimal.ROUND_DOWN); 
      ...
      if (this._inputs.STKL == 2) {
          ...
          if (this._inputs.STKL == 3) {
                ...
                if (this._inputs.STKL == 4) {
                    ...
                    this._internals.SAP= BigDecimal.valueOf (36);
                    this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (3714))).setScale (0, BigDecimal.ROUND_DOWN);
    ...
    if (this._internals.ZZX.compareTo(this._internals.W2STKL5) == 1) {
      ...
      if (this._internals.ZZX.compareTo (this._internals.W3STKL5) == 1) {
        ...
        if (this._internals.ZZX.compareTo (this._internals.W1STKL5) == 1) { 
            ...
            this.UP5_6();
            this._internals.HOCH= (this._internals.ST.add ((this._internals.ZZX.subtract (this._internals.W1STKL5)).multiply (BigDecimal.valueOf (0.42)))).setScale (0, BigDecimal.ROUND_DOWN);
  ...
  UPTAB18() {
    if (this._internals.X.compareTo(this._internals.GFB.add(ZAHL1)) == -1) { 
        ...
        if (this._internals.X.compareTo (BigDecimal.valueOf (13997)) == -1) {
          
            this._internals.Y = (this._internals.X.subtract(this._internals.GFB)).divide(ZAHL10000, 6,BigDecimal.ROUND_DOWN); 
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (997.8)); 
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (54950)) == -1) {
              
                this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (13996))).divide (ZAHL10000, 6, BigDecimal.ROUND_DOWN);
                this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (220.13));
                ...
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (948.49))).setScale (0, BigDecimal.ROUND_DOWN); 
              
              } else {
              if (this._internals.X.compareTo (BigDecimal.valueOf (260533)) == -1) {
                
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (8621.75))).setScale (0, BigDecimal.ROUND_DOWN); 
                  
                  } else {
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (16437.7))).setScale (0, BigDecimal.ROUND_DOWN); 
