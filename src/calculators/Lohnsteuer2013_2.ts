...
VERGL : BigDecimal;
  ...
  VKVSONST : BigDecimal;
        ...
        /**  Neuer Wert  2013  */
      export const RENTBEMESSUNGSGR_OST_2013 = new BigDecimal(58800);
      
      /**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
      /**  Neuer Wert 2013  */
      export const RENTBEMESSUNGSGR_WEST = new BigDecimal(69600);

    

export class Lohnsteuer2013Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  static readonly RENTBEMESSUNGSGR_OST_2013 = RENTBEMESSUNGSGR_OST_2013;
  static readonly RENTBEMESSUNGSGR_WEST = RENTBEMESSUNGSGR_WEST;


  public name = 'Lohnsteuer2013Big';
  public _inputs = {
    af : 1.0,
    AJAHR : 0,
    ALTER1 : 0,
    ...
    if (this._inputs.KRV > 1) {
        ...
        this._internals.VSP1= BigDecimal.ZERO();
            ...
            if (this._inputs.KRV == 0) {
              ...
              if (this._internals.ZRE4VP.compareTo(RENTBEMESSUNGSGR_OST_2013) == 1) {
                
                  this._internals.ZRE4VP = RENTBEMESSUNGSGR_OST_2013;
                
              } 
            }
             /**  Neuer Wert 2013  */ 
            this._internals.VSP1 = (this._internals.ZRE4VP.multiply(BigDecimal.valueOf(0.52))).setScale(2,BigDecimal.ROUND_DOWN);
  ...
  MVSP() {
   /**  Neuer Wert 2013  */  
    if (this._internals.ZRE4VP.compareTo( BigDecimal.valueOf(47250) ) == 1) {
      
       /**  Neuer Wert 2013  */  
      this._internals.ZRE4VP = BigDecimal.valueOf(47250);
  ...
  MST5_6() {
    ...
    if (this._internals.ZZX.compareTo (BigDecimal.valueOf (26441)) == 1) {
      ...
      if (this._internals.ZZX.compareTo (BigDecimal.valueOf (200584)) == 1) {
        ...
        this.UP5_6();
        if (this._internals.ZZX.compareTo (BigDecimal.valueOf (9550)) == 1) {
          
            this._internals.VERGL= this._internals.ST;
            this._internals.ZX= BigDecimal.valueOf (9550);
            this.UP5_6();
            this._internals.HOCH= (this._internals.ST.add ((this._internals.ZZX.subtract (BigDecimal.valueOf (9550))).multiply (BigDecimal.valueOf (0.42)))).setScale (0, BigDecimal.ROUND_DOWN);
  ...
  UPTAB13() {
    if (this._internals.X.compareTo (BigDecimal.valueOf (8131)) == -1) {
        ...
        if (this._internals.X.compareTo (BigDecimal.valueOf (13470)) == -1) {
            ...
            this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (8130))).divide (BigDecimal.valueOf (10000), 6, BigDecimal.ROUND_DOWN);
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (933.7));
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (52882)) == -1) {
                ...
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (1014))).setScale (0, BigDecimal.ROUND_DOWN);
              
              } else {
              if (this._internals.X.compareTo (BigDecimal.valueOf (250731)) == -1) {
                
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (8196))).setScale (0, BigDecimal.ROUND_DOWN);
                  
                  } else {
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (15718))).setScale (0, BigDecimal.ROUND_DOWN);
