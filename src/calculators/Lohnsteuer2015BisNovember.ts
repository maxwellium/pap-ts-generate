...
export class Lohnsteuer2015Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  MST5_6() {
    ...
    if (this._internals.ZZX.compareTo (BigDecimal.valueOf (26441)) == 1) {
      ...
      if (this._internals.ZZX.compareTo (BigDecimal.valueOf (200584)) == 1) {
        ...
        this.UP5_6();
        if (this._internals.ZZX.compareTo (BigDecimal.valueOf (9763)) == 1) { 
          
            this._internals.VERGL= this._internals.ST;
            this._internals.ZX= BigDecimal.valueOf (9763); 
            this.UP5_6();
