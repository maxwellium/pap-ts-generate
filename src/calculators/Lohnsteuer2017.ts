...
export class Lohnsteuer2017Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  MPARA() {
     if (this._inputs.KRV < 2) {/**  &lt; = <  */
          ...
          if (this._inputs.KRV == 0) {
              ...
              this._internals.BBGRV = new BigDecimal(76200);  /**  Neu 2017  */
            
            } else {
              this._internals.BBGRV = new BigDecimal(68400);  /**  Neu 2017  */
            
          }
          this._internals.RVSATZAN = BigDecimal.valueOf(0.0935);
          this._internals.TBSVORV = BigDecimal.valueOf(0.68);  /**  Neu 2017  */
         ...
         this._internals.BBGKVPV = new BigDecimal(52200); /**  Neu 2017  */
        ...
        if (this._inputs.PVS == 1) {
            ...
            this._internals.PVSATZAN = BigDecimal.valueOf(0.01775); /**  Neu 2017  */
            this._internals.PVSATZAG = BigDecimal.valueOf(0.00775); /**  Neu 2017  */
          
          } else {
            this._internals.PVSATZAN =  BigDecimal.valueOf(0.01275); /**  Neu 2017  */
            this._internals.PVSATZAG =  BigDecimal.valueOf(0.01275); /**  Neu 2017  */
        ...
        if (this._inputs.PVZ == 1) {
         ...
         /**  Anfang Neu 2017  */ 
         this._internals.W1STKL5 = new BigDecimal(10240);
         this._internals.W2STKL5 = new BigDecimal(27029);
         this._internals.W3STKL5 = new BigDecimal(205043);
         this._internals.GFB = new BigDecimal(8820);
          /**  Ende Neu 2017  */
...
/**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 21  */
  MZTABFB() { 
    ...
    if (this._inputs.STKL == 1) {
        ...
        this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (7356))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neu 2017  */
      ...
      if (this._inputs.STKL == 2) {
          ...
          if (this._inputs.STKL == 3) {
                ...
                if (this._inputs.STKL == 4) {
                    ...
                    this._internals.SAP= BigDecimal.valueOf (36);
                    this._internals.KFB= (this._inputs.ZKF.multiply (BigDecimal.valueOf (3678))).setScale (0, BigDecimal.ROUND_DOWN); /**  Neu 2017  */
  ...
  UPTAB17() {
    if (this._internals.X.compareTo(this._internals.GFB.add(ZAHL1)) == -1) { 
        ...
        if (this._internals.X.compareTo (BigDecimal.valueOf (13770)) == -1) {
          
            this._internals.Y = (this._internals.X.subtract(this._internals.GFB)).divide(ZAHL10000, 6,BigDecimal.ROUND_DOWN); 
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (1007.27)); 
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (54058)) == -1) {
              
                this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (13769))).divide (ZAHL10000, 6, BigDecimal.ROUND_DOWN);
                this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (223.76));
                ...
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (939.57))).setScale (0, BigDecimal.ROUND_DOWN); 
              
              } else {
              if (this._internals.X.compareTo (BigDecimal.valueOf (256304)) == -1) {
                
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (8475.44))).setScale (0, BigDecimal.ROUND_DOWN); 
                  
                  } else {
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (16164.53))).setScale (0, BigDecimal.ROUND_DOWN); 
