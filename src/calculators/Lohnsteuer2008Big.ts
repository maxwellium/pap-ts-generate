...
export class Lohnsteuer2008Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  public _internals = {
    ...
    ZRE4OSO : new BigDecimal(0),
    ZRE4VMT : new BigDecimal(0),
    ZRE4VP : new BigDecimal(0),
    ZTABFB : new BigDecimal(0),
    ZTABFBOSO : new BigDecimal(0),
  ...
  MRE4() {
    if (this._internals.ZVBEZJ.compareTo (BigDecimal.ZERO()) == 0) {
        ...
        if ((TAB3[3]).compareTo (this._internals.HFVBZSO) == 1) {
  ...
  MLSTJAHR() {
    ...
    if (this._internals.KENNVMT == 0) {
        ...
        if (this._internals.KENNVMT == 1) {
            ...
            this._internals.ZVE= this._internals.ZRE4OSO.subtract (this._internals.ZTABFBOSO).add (this._internals.ZRE4VMT).subtract (this._internals.VSP).setScale (2, BigDecimal.ROUND_DOWN);
          
          } else {
            this._internals.ZVE= (((this._internals.ZRE4.subtract (this._internals.ZTABFB)).divide (ZAHL5)).subtract (this._internals.VSP)).setScale (2, BigDecimal.ROUND_DOWN);
  ...
  /**  Achtung: Er wird davon ausgegangen, dass
    ...
    if (this._inputs.KRV > 0) {
        ...
        if (this._internals.ZRE4VP.compareTo (BigDecimal.valueOf (63600)) == 1) {
          
            this._internals.ZRE4VP= BigDecimal.valueOf (63600);
          
        }
        this._internals.VSP1= (this._internals.ZRE4VP.multiply (BigDecimal.valueOf (0.32))).setScale (2, BigDecimal.ROUND_DOWN);
  ...
  MVMT() {
    ...
    if ((this._inputs.VMT.add (this._inputs.VKAPA)).compareTo (BigDecimal.ZERO()) == 1) {
        ...
        this._internals.ZTABFB= (this._internals.ZTABFB.subtract (this._internals.FVBZ).add (this._internals.FVBZOSO)).setScale (2, BigDecimal.ROUND_DOWN);
        this._internals.KENNVMT= 1;
        if ((this._inputs.JRE4.add (this._inputs.SONSTB).subtract (this._inputs.JFREIB).add (this._inputs.JHINZU)).compareTo (BigDecimal.ZERO()) == -1) {
            ...
            this._internals.ZRE4VMT= (((this._inputs.VMT.divide (ZAHL100)).add (this._inputs.VKAPA.divide (ZAHL100)).subtract (this._internals.ZTABFB).add (this._internals.ZTABFBOSO)).divide (ZAHL5)).setScale (2, BigDecimal.ROUND_DOWN);
            this.MLSTJAHR();
            this._internals.LST2= this._internals.ST.multiply (ZAHL100);
