...
export class Lohnsteuer2011Big extends PAPBaseClass<Inputs, Outputs, Internals> {
  ...
  public _internals = {
    RENTBEMESSUNGSGR_OST_2011 : new BigDecimal(57600),
    RENTBEMESSUNGSGR_WEST : new BigDecimal(66000),
  ...
  UPANP12() {
    if (this._inputs.LZZ == 1) {
        ...
        if ((this._internals.ZRE4.subtract(this._internals.ZVBEZ)).compareTo(BigDecimal.valueOf(1000)) == -1) {
            ...
            this._internals.ANP = this._internals.ANP.add(BigDecimal.valueOf(1000));
          
        }
      
      } else {
      if ((this._internals.ZRE4.subtract(this._internals.ZVBEZ)).compareTo(BigDecimal.valueOf(1880)) == -1) {
        
          this._internals.ANP = ((this._internals.ANP.add(this._internals.ZRE4)).subtract(this._internals.ZVBEZ)).setScale(0,BigDecimal.ROUND_UP);;
        
        } else {
          this._internals.ANP = this._internals.ANP.add(BigDecimal.valueOf(1880));
    ...
    if (this._inputs.KRV > 1) {
        ...
        this._internals.VSP1= BigDecimal.ZERO();
            ...
            if (this._inputs.KRV == 0) {
                  ...
                  if (this._internals.ZRE4VP.compareTo (BigDecimal.valueOf (66000)) == 1) {
                    
                      this._internals.ZRE4VP= BigDecimal.valueOf (66000);
            ...
            this._internals.VSP1= (this._internals.ZRE4VP.multiply (BigDecimal.valueOf (0.44))).setScale (2, BigDecimal.ROUND_DOWN);
  ...
  MVSP() {
    if (this._internals.ZRE4VP.compareTo( BigDecimal.valueOf(44550) ) == 1) {
      
          this._internals.ZRE4VP = BigDecimal.valueOf(44550);
    ...
    if (this._inputs.PKV > 0) {
          ...
          if (this._inputs.STKL == 6) {
                ...
                this._internals.VSP = this._inputs.PKPV.multiply(ZAHL12).divide(ZAHL100);
                if (this._inputs.PKV == 2) {
                  
                      this._internals.KVSATZAG = BigDecimal.valueOf(0.07).setScale(5);
                      if (this._inputs.PVS == 1) {
                        
                          this._internals.PVSATZAG = BigDecimal.valueOf(0.00475).setScale(5);
                        
                        } else {
                          this._internals.PVSATZAG = BigDecimal.valueOf(0.00975).setScale(5);
                        
                      }
                      this._internals.VSP = this._internals.VSP.subtract(this._internals.ZRE4VP.multiply(this._internals.KVSATZAG.add(this._internals.PVSATZAG))).setScale(2, BigDecimal.ROUND_DOWN);
        ...
        if (this._inputs.PVS == 1) {
            ...
            this._internals.PVSATZAN = BigDecimal.valueOf(0.01475).setScale(5);
          
          } else {
            this._internals.PVSATZAN = BigDecimal.valueOf(0.00975).setScale(5);
        ...
        this._internals.VSP = this._internals.ZRE4VP.multiply(this._internals.KVSATZAN.add(this._internals.PVSATZAN)).setScale(2, BigDecimal.ROUND_DOWN);
      
    }
    this._internals.VSP = this._internals.VSP.add(this._internals.VSP1).setScale(0, BigDecimal.ROUND_UP);
  }
  ...
  MST5_6() {
    ...
    if (this._internals.ZZX.compareTo (BigDecimal.valueOf (26441)) == 1) {
      ...
      if (this._internals.ZZX.compareTo (BigDecimal.valueOf (200584)) == 1) {
        ...
        this.UP5_6();
        if (this._internals.ZZX.compareTo (BigDecimal.valueOf (9429)) == 1) {
          
            this._internals.VERGL= this._internals.ST;
            this._internals.ZX= BigDecimal.valueOf (9429);
            this.UP5_6();
            this._internals.HOCH= (this._internals.ST.add ((this._internals.ZZX.subtract (BigDecimal.valueOf (9429))).multiply (BigDecimal.valueOf (0.42)))).setScale (0, BigDecimal.ROUND_DOWN);
  ...
  UPTAB10() {
    if (this._internals.X.compareTo (BigDecimal.valueOf (8005)) == -1) {
        ...
        if (this._internals.X.compareTo (BigDecimal.valueOf (13470)) == -1) {
            ...
            this._internals.Y= (this._internals.X.subtract (BigDecimal.valueOf (8004))).divide (BigDecimal.valueOf (10000), 6, BigDecimal.ROUND_DOWN);
            this._internals.RW= this._internals.Y.multiply (BigDecimal.valueOf (912.17));
            ...
            if (this._internals.X.compareTo (BigDecimal.valueOf (52882)) == -1) {
                ...
                this._internals.ST= (this._internals.RW.add (BigDecimal.valueOf (1038))).setScale (0, BigDecimal.ROUND_DOWN);
              
              } else {
              if (this._internals.X.compareTo (BigDecimal.valueOf (250731)) == -1) {
                
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.42))).subtract (BigDecimal.valueOf (8172))).setScale (0, BigDecimal.ROUND_DOWN);
                  
                  } else {
                    this._internals.ST= ((this._internals.X.multiply (BigDecimal.valueOf (0.45))).subtract (BigDecimal.valueOf (15694))).setScale (0, BigDecimal.ROUND_DOWN);
