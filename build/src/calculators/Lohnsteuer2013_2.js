...
/**  Neuer Wert  2013  */
exports.RENTBEMESSUNGSGR_OST_2013 = new bigdecimal_1.BigDecimal(58800);
/**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
/**  Neuer Wert 2013  */
exports.RENTBEMESSUNGSGR_WEST = new bigdecimal_1.BigDecimal(69600);
class Lohnsteuer2013Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2013Big';
        this._inputs = {
            af: 1.0,
            AJAHR: 0,
            ALTER1: 0,
    ...
    UPVKVLZZ() {
        ...
        this.UPANTEIL();
        this._internals.VKVLZZ = this._internals.ANTEIL1;
    }
    UPVKV() {
    ...
    /**    Vorsorgepauschale (§ 39b Absatz 2 Satz 5 Nummer 3 und Absatz 4 EStG)
          Achtung: Es wird davon ausgegangen, dass
            a) Es wird davon ausge-gangen, dassa) this._inputs.für die BBG (Ost) 58.800 Euro und this._inputs.für die BBG (West) 69.600 Euro festgelegt wird sowie
    ...
    UPEVP() {
        if (this._inputs.KRV > 1) {
            ...
            if (this._inputs.KRV == 0) {
                /**  Neuer Wert 2013  */
                if (this._internals.ZRE4VP.compareTo(exports.RENTBEMESSUNGSGR_WEST) == 1) {
                    this._internals.ZRE4VP = exports.RENTBEMESSUNGSGR_WEST;
                }
            }
            else { /**  Neuer Wert 2013  */
                if (this._internals.ZRE4VP.compareTo(exports.RENTBEMESSUNGSGR_OST_2013) == 1) {
                    this._internals.ZRE4VP = exports.RENTBEMESSUNGSGR_OST_2013;
                }
            }
            /**  Neuer Wert 2013  */
            this._internals.VSP1 = (this._internals.ZRE4VP.multiply(bigdecimal_1.BigDecimal.valueOf(0.52))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
            this._internals.VSP1 = (this._internals.VSP1.multiply(bigdecimal_1.BigDecimal.valueOf(0.0945))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
        }
    ...
    MVSP() {
        /**  Neuer Wert 2013  */
        if (this._internals.ZRE4VP.compareTo(bigdecimal_1.BigDecimal.valueOf(47250)) == 1) {
            /**  Neuer Wert 2013  */
            this._internals.ZRE4VP = bigdecimal_1.BigDecimal.valueOf(47250);
        }
        if (this._inputs.PKV > 0) {
            if (this._inputs.STKL == 6) {
                ...
                if (this._inputs.PKV == 2) {
                    ...
                    if (this._inputs.PVS == 1) {
                        this._internals.PVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.00525).setScale(5);
                    }
                    else {
                        this._internals.PVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.01025).setScale(5);
                    }
            ...
            if (this._inputs.PVS == 1) {
                this._internals.PVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.01525).setScale(5);
            }
            else {
                this._internals.PVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.01025).setScale(5);
            }
    ...
    MST5_6() {
        ...
        if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(26441)) == 1) {
            ...
            this.UP5_6();
            if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(9550)) == 1) {
                this._internals.VERGL = this._internals.ST;
                this._internals.ZX = bigdecimal_1.BigDecimal.valueOf(9550);
                this.UP5_6();
                this._internals.HOCH = (this._internals.ST.add((this._internals.ZZX.subtract(bigdecimal_1.BigDecimal.valueOf(9550))).multiply(bigdecimal_1.BigDecimal.valueOf(0.42)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
    ...
    MSONST() {
        ...
        if (this._inputs.SONSTB.compareTo(bigdecimal_1.BigDecimal.ZERO()) == 0) {
            this._internals.VKVSONST = bigdecimal_1.BigDecimal.ZERO();
            ...
            this.MOSONST();
            this.UPVKV();
            this._internals.VKVSONST = this._internals.VKV;
            ...
            this.MLSTJAHR();
            this.UPVKV();
            this._internals.VKVSONST = this._internals.VKV.subtract(this._internals.VKVSONST);
    ...
    UPTAB13() {
        if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(8131)) == -1) {
            this._internals.ST = bigdecimal_1.BigDecimal.ZERO();
        }
        else {
            if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(13470)) == -1) {
                this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(8130))).divide(bigdecimal_1.BigDecimal.valueOf(10000), 6, bigdecimal_1.BigDecimal.ROUND_DOWN);
                this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(933.7));
                ...
                if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(52882)) == -1) {
                    ...
                    this._internals.ST = (this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(1014))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                }
                else {
                    if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(250731)) == -1) {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.42))).subtract(bigdecimal_1.BigDecimal.valueOf(8196))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.45))).subtract(bigdecimal_1.BigDecimal.valueOf(15718))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                }
            }
        }
...
Lohnsteuer2013Big.TAB1 = exports.TAB1;
Lohnsteuer2013Big.TAB2 = exports.TAB2;
Lohnsteuer2013Big.TAB3 = exports.TAB3;
Lohnsteuer2013Big.TAB4 = exports.TAB4;
Lohnsteuer2013Big.TAB5 = exports.TAB5;
Lohnsteuer2013Big.ZAHL0 = exports.ZAHL0;
Lohnsteuer2013Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2013Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2013Big.ZAHL3 = exports.ZAHL3;
Lohnsteuer2013Big.ZAHL4 = exports.ZAHL4;
Lohnsteuer2013Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2013Big.ZAHL6 = exports.ZAHL6;
Lohnsteuer2013Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2013Big.ZAHL8 = exports.ZAHL8;
Lohnsteuer2013Big.ZAHL9 = exports.ZAHL9;
Lohnsteuer2013Big.ZAHL10 = exports.ZAHL10;
Lohnsteuer2013Big.ZAHL11 = exports.ZAHL11;
Lohnsteuer2013Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2013Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2013Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2013Big.ZAHL500 = exports.ZAHL500;
Lohnsteuer2013Big.ZAHL700 = exports.ZAHL700;
Lohnsteuer2013Big.ZAHL1000 = exports.ZAHL1000;
Lohnsteuer2013Big.RENTBEMESSUNGSGR_OST_2013 = exports.RENTBEMESSUNGSGR_OST_2013;
Lohnsteuer2013Big.RENTBEMESSUNGSGR_WEST = exports.RENTBEMESSUNGSGR_WEST;
exports.Lohnsteuer2013Big = Lohnsteuer2013Big;
//# sourceMappingURL=Lohnsteuer2013_2.js.map