...
class Lohnsteuer2016Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2016Big';
        this._inputs = {
            af: 1,
            AJAHR: 0,
            ALTER1: 0,
    ...
    MPARA() {
        if (this._inputs.KRV < 2) { /**  &lt; = <  */
            if (this._inputs.KRV == 0) {
                this._internals.BBGRV = new bigdecimal_1.BigDecimal(74400); /**  Neu 2016  */
            }
            else {
                this._internals.BBGRV = new bigdecimal_1.BigDecimal(64800); /**  Neu 2016  */
            }
            this._internals.RVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.0935);
            this._internals.TBSVORV = bigdecimal_1.BigDecimal.valueOf(0.64); /**  Neu 2016  */
        }
        else {
            /**  Nichts zu tun  */
        }
        this._internals.BBGKVPV = new bigdecimal_1.BigDecimal(50850); /**  Neu 2016  */
        ...
        /**  Anfang Neu 2016  */
        this._internals.W1STKL5 = new bigdecimal_1.BigDecimal(10070);
        this._internals.W2STKL5 = new bigdecimal_1.BigDecimal(26832);
        this._internals.W3STKL5 = new bigdecimal_1.BigDecimal(203557);
        this._internals.GFB = new bigdecimal_1.BigDecimal(8652);
    ...
    MBERECH() {
        ...
        this._outputs.VFRB = ((this._internals.ANP.add(this._internals.FVB.add(this._internals.FVBZ))).multiply(exports.ZAHL100)).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN); /**  Neu 2016  */
        this.MLSTJAHR();
        /**  Anfang Neu 2016  */
    ...
    MZTABFB() {
        ...
        if (this._inputs.STKL == 1) {
            ...
            this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(7248))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN); /**  Neu 2016  */
        }
        else {
            if (this._inputs.STKL == 2) {
                ...
                if (this._inputs.STKL == 3) {
                    ...
                    if (this._inputs.STKL == 4) {
                        this._internals.SAP = bigdecimal_1.BigDecimal.valueOf(36);
                        this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(3624))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN); /**  Neu 2016  */
                    }
                    else {
    ...
    MSOLZ() {
        this._internals.SOLZFREI = (this._internals.SOLZFREI.multiply(bigdecimal_1.BigDecimal.valueOf(this._internals.KZTAB))); /**  Neu 2016  */
    ...
    UPTAB16() {
        if (this._internals.X.compareTo(this._internals.GFB.add(exports.ZAHL1)) == -1) {
            ...
            if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(13670)) == -1) {
                ...
                this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(993.62));
                ...
                if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(53666)) == -1) {
                    this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(13669))).divide(exports.ZAHL10000, 6, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(225.40));
                    ...
                    this._internals.ST = (this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(952.48))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                }
                else {
                    if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(254447)) == -1) {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.42))).subtract(bigdecimal_1.BigDecimal.valueOf(8394.14))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.45))).subtract(bigdecimal_1.BigDecimal.valueOf(16027.52))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                }
            }
        }
...
Lohnsteuer2016Big.TAB1 = exports.TAB1;
Lohnsteuer2016Big.TAB2 = exports.TAB2;
Lohnsteuer2016Big.TAB3 = exports.TAB3;
Lohnsteuer2016Big.TAB4 = exports.TAB4;
Lohnsteuer2016Big.TAB5 = exports.TAB5;
Lohnsteuer2016Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2016Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2016Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2016Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2016Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2016Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2016Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2016Big.ZAHL500 = exports.ZAHL500;
Lohnsteuer2016Big.ZAHL700 = exports.ZAHL700;
Lohnsteuer2016Big.ZAHL1000 = exports.ZAHL1000;
Lohnsteuer2016Big.ZAHL10000 = exports.ZAHL10000;
exports.Lohnsteuer2016Big = Lohnsteuer2016Big;
//# sourceMappingURL=Lohnsteuer2016.js.map