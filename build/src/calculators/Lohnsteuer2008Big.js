...
class Lohnsteuer2008Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2008Big';
        this._inputs = {
            AJAHR: 0,
            ALTER1: 0,
        ...
        this._internals = {
            ...
            FVBZOSO: new bigdecimal_1.BigDecimal(0),
            ...
            ZRE4OSO: new bigdecimal_1.BigDecimal(0),
            ZRE4VMT: new bigdecimal_1.BigDecimal(0),
            ZRE4VP: new bigdecimal_1.BigDecimal(0),
            ZTABFB: new bigdecimal_1.BigDecimal(0),
            ZTABFBOSO: new bigdecimal_1.BigDecimal(0),
    ...
    MRE4() {
        if (this._internals.ZVBEZJ.compareTo(bigdecimal_1.BigDecimal.ZERO()) == 0) {
            ...
            if ((exports.TAB3[3]).compareTo(this._internals.HFVBZSO) == 1) {
    ...
    MLSTJAHR() {
        ...
        if (this._internals.KENNVMT == 0) {
            ...
            if (this._internals.KENNVMT == 1) {
                this._internals.ZVE = this._internals.ZRE4OSO.subtract(this._internals.ZTABFBOSO).add(this._internals.ZRE4VMT).subtract(this._internals.VSP).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
            }
            else {
                this._internals.ZVE = (((this._internals.ZRE4.subtract(this._internals.ZTABFB)).divide(exports.ZAHL5)).subtract(this._internals.VSP)).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
            }
        }
    ...
    UPEVP() {
        ...
        if (this._inputs.KRV > 0) {
            ...
            if (this._internals.ZRE4VP.compareTo(bigdecimal_1.BigDecimal.valueOf(63600)) == 1) {
                this._internals.ZRE4VP = bigdecimal_1.BigDecimal.valueOf(63600);
            }
            this._internals.VSP1 = (this._internals.ZRE4VP.multiply(bigdecimal_1.BigDecimal.valueOf(0.32))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
    ...
    MVMT() {
        ...
        if ((this._inputs.VMT.add(this._inputs.VKAPA)).compareTo(bigdecimal_1.BigDecimal.ZERO()) == 1) {
            ...
            this._internals.ZRE4OSO = this._internals.ZRE4;
            this._internals.ZTABFBOSO = this._internals.ZTABFB;
            this._internals.FVBZOSO = this._internals.FVBZ;
            ...
            this._internals.ZTABFB = (this._internals.ZTABFB.subtract(this._internals.FVBZ).add(this._internals.FVBZOSO)).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
            this._internals.KENNVMT = 1;
            if ((this._inputs.JRE4.add(this._inputs.SONSTB).subtract(this._inputs.JFREIB).add(this._inputs.JHINZU)).compareTo(bigdecimal_1.BigDecimal.ZERO()) == -1) {
                ...
                this._internals.ZRE4VMT = (((this._inputs.VMT.divide(exports.ZAHL100)).add(this._inputs.VKAPA.divide(exports.ZAHL100)).subtract(this._internals.ZTABFB).add(this._internals.ZTABFBOSO)).divide(exports.ZAHL5)).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
                this.MLSTJAHR();
                this._internals.LST2 = this._internals.ST.multiply(exports.ZAHL100);
...
Lohnsteuer2008Big.TAB1 = exports.TAB1;
Lohnsteuer2008Big.TAB2 = exports.TAB2;
Lohnsteuer2008Big.TAB3 = exports.TAB3;
Lohnsteuer2008Big.TAB4 = exports.TAB4;
Lohnsteuer2008Big.TAB5 = exports.TAB5;
Lohnsteuer2008Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2008Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2008Big.ZAHL3 = exports.ZAHL3;
Lohnsteuer2008Big.ZAHL4 = exports.ZAHL4;
Lohnsteuer2008Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2008Big.ZAHL6 = exports.ZAHL6;
Lohnsteuer2008Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2008Big.ZAHL8 = exports.ZAHL8;
Lohnsteuer2008Big.ZAHL9 = exports.ZAHL9;
Lohnsteuer2008Big.ZAHL10 = exports.ZAHL10;
Lohnsteuer2008Big.ZAHL11 = exports.ZAHL11;
Lohnsteuer2008Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2008Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2008Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2008Big.ZAHL700 = exports.ZAHL700;
exports.Lohnsteuer2008Big = Lohnsteuer2008Big;
