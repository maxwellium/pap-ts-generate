...
class Lohnsteuer2015DezemberBig extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2015DezemberBig';
        this._inputs = {
            af: 1.0,
            AJAHR: 0,
            ALTER1: 0,
        ...
        this._internals = {
            ...
            JWLSTA: new bigdecimal_1.BigDecimal(0),
            JWLSTN: new bigdecimal_1.BigDecimal(0),
            JWSOLZA: new bigdecimal_1.BigDecimal(0),
            JWSOLZN: new bigdecimal_1.BigDecimal(0),
            JWBKA: new bigdecimal_1.BigDecimal(0),
            JWBKN: new bigdecimal_1.BigDecimal(0),
            K: 0,
            KENNVMT: 0,
            ...
            ZRE4VPM: new bigdecimal_1.BigDecimal(0),
    ...
    main() {
        ...
        this.MRE4ABZ();
        /**  Anfang Neu 2015  */
        this._internals.ZRE4VPM = this._internals.ZRE4VP;
        this._internals.SCHLEIFZ = 1;
        this.MBERECH();
        this._internals.SCHLEIFZ = 2;
        this._internals.W1STKL5 = bigdecimal_1.BigDecimal.valueOf(9873);
        this._internals.ZRE4VP = this._internals.ZRE4VPM;
        this.MBERECH();
        this.MLST1215();
        /**  Ende Neu 2015   */
        /**
        ...
        <EVAL exec="this._internals.LSTJAHR= this._internals.ST.multiply(BigDecimal.valueOf(this._inputs.f)).setScale(0,BigDecimal.ROUND_DOWN)"/>
        <EVAL exec="this._internals.JW= this._internals.LSTJAHR.multiply(ZAHL100)"/>
        <EXECUTE method="UPLSTLZZ"/>
        <EXECUTE method="UPVKVLZZ"/>
    
        <IF expr="this._inputs.ZKF.compareTo (BigDecimal.ZERO()) == 1">
          <THEN>
              <EVAL exec="this._internals.ZTABFB= (this._internals.ZTABFB.add (this._internals.KFB)).setScale (2, BigDecimal.ROUND_DOWN)"/>
              <EXECUTE method="MRE4ABZ"/>
              <EXECUTE method="MLSTJAHR"/>
              <EVAL exec="this._internals.JBMG= this._internals.ST.multiply(BigDecimal.valueOf(this._inputs.f)).setScale(0, BigDecimal.ROUND_DOWN)"/>
          </THEN>
          <ELSE>
              <EVAL exec="this._internals.JBMG= this._internals.LSTJAHR"/>
          </ELSE>
        </IF>
    ...
    /**  Zuweisung von Werten this._inputs.für bestimmte Sozialversicherungsparameter  PAP Seite 15  */
    MPARA() {
        if (this._inputs.KRV < 2) { /**  &lt; = <  */
            if (this._inputs.KRV == 0) {
                this._internals.BBGRV = new bigdecimal_1.BigDecimal(72600);
            }
            else {
                this._internals.BBGRV = new bigdecimal_1.BigDecimal(62400);
            }
            this._internals.RVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.0935);
            this._internals.TBSVORV = bigdecimal_1.BigDecimal.valueOf(0.60);
        }
        else {
            /**  Nichts zu tun  */
        }
        this._internals.BBGKVPV = new bigdecimal_1.BigDecimal(49500);
        ...
        if (this._inputs.PVS == 1) {
            this._internals.PVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.01675);
            this._internals.PVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.00675);
        }
        else {
            this._internals.PVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.01175);
            this._internals.PVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.01175);
        }
        if (this._inputs.PVZ == 1) {
            this._internals.PVSATZAN = this._internals.PVSATZAN.add(bigdecimal_1.BigDecimal.valueOf(0.0025));
        }
        /**  Anfang Neu 2015  */
        this._internals.W1STKL5 = new bigdecimal_1.BigDecimal(9763);
        this._internals.W2STKL5 = new bigdecimal_1.BigDecimal(26441);
        this._internals.W3STKL5 = new bigdecimal_1.BigDecimal(200584);
        /**  Ende Neu 2015  */
    }
    ...
    /**  Freibeträge this._inputs.für Versorgungsbezüge, Altersentlastungsbetrag (§ 39b Abs. 2 Satz 3 EStG), PAP Seite 17  */
    MRE4() {
    ...
    /**  Komplett Neu 2015  */
    /**  LohnzahlungszeitraumSchleife this._inputs.für Differenzrechnung Dezember 2015 Seite 21  */
    MBERECH() {
        if (this._internals.SCHLEIFZ == 1) {
            this.MZTABFBA();
        }
        else {
            this.MZTABFBN();
    ...
    MZTABFBN() {
        ...
        if (this._inputs.STKL == 1) {
            this._internals.SAP = bigdecimal_1.BigDecimal.valueOf(36);
            this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(7152))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
        }
        else {
            if (this._inputs.STKL == 2) {
                ...
                if (this._inputs.STKL == 3) {
                    ...
                    if (this._inputs.STKL == 4) {
                        this._internals.SAP = bigdecimal_1.BigDecimal.valueOf(36);
                        this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(3576))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
                        if (this._inputs.STKL == 5) {
                            this._internals.SAP = bigdecimal_1.BigDecimal.valueOf(36);
    ...
    UPLSTLZZ() {
        ...
        /**  Anfang Neu 2015  */
        if (this._internals.SCHLEIFZ == 1) {
            this._internals.JWLSTA = this._internals.JW;
        }
        else {
            this._internals.JWLSTN = this._internals.JW;
        }
        /**  Ende Neu 2015  */
        this.UPANTEIL();
    ...
    MSOLZ() {
        ...
        if (this._internals.JBMG.compareTo(this._internals.SOLZFREI) == 1) {
            ...
            /**  Anfang Neu 2015  */
            if (this._internals.SCHLEIFZ == 1) {
                this._internals.JWSOLZA = this._internals.JW;
            }
            else {
                this._internals.JWSOLZN = this._internals.JW;
            }
            /**  Ende Neu 2015  */
            this.UPANTEIL();
        ...
        if (this._inputs.R > 0) {
            ...
            /**  Anfang Neu 2015  */
            if (this._internals.SCHLEIFZ == 1) {
                this._internals.JWBKA = this._internals.JW;
            }
            else {
                this._internals.JWBKN = this._internals.JW;
            }
            /**  Ende Neu 2015  */
            this.UPANTEIL();
    ...
    MLST1215() {
        if (this._inputs.LZZ > 1) {
            this._internals.JW = (this._internals.JWLSTN.subtract(bigdecimal_1.BigDecimal.valueOf(11).multiply((this._internals.JWLSTA.subtract(this._internals.JWLSTN))))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
            if (this._internals.JW.compareTo(bigdecimal_1.BigDecimal.ZERO()) == -1) { /**  this._internals.JW < 0  */
                this._internals.ANTEIL1 = bigdecimal_1.BigDecimal.ZERO();
            }
            else {
                this.UPANTEIL();
            }
            this._outputs.LSTLZZ = this._internals.ANTEIL1;
            this._internals.JW = (this._internals.JWSOLZN.subtract(bigdecimal_1.BigDecimal.valueOf(11).multiply(this._internals.JWSOLZA.subtract(this._internals.JWSOLZN)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
            if (this._internals.JW.compareTo(bigdecimal_1.BigDecimal.ZERO()) == -1) { /**  this._internals.JW < 0  */
                this._internals.ANTEIL1 = bigdecimal_1.BigDecimal.ZERO();
            }
            else {
            ...
            this._outputs.SOLZLZZ = this._internals.ANTEIL1;
            this._internals.JW = (this._internals.JWBKN.subtract(bigdecimal_1.BigDecimal.valueOf(11).multiply(this._internals.JWBKA.subtract(this._internals.JWBKN)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
            if (this._internals.JW.compareTo(bigdecimal_1.BigDecimal.ZERO()) == -1) { /**  this._internals.JW < 0  */
                this._internals.ANTEIL1 = bigdecimal_1.BigDecimal.ZERO();
            }
            else {
    ...
    /**  Anteil von Jahresbetraegen fuer einen this._inputs.LZZ (§ 39b Abs. 2 Satz 9 EStG), PAP Seite 34  */
    UPANTEIL() {
        if (this._inputs.LZZ == 1) {
    ...
    /**  Sonderberechnung ohne sonstige Bezüge this._inputs.für Berechnung bei sonstigen Bezügen oder Vergütung this._inputs.für mehrjährige Tätigkeit, PAP Seite 37  */
    MOSONST() {
    ...
    /**  Sonderberechnung mit sonstige Bezüge this._inputs.für Berechnung bei sonstigen Bezügen oder Vergütung this._inputs.für mehrjährige Tätigkeit, PAP Seite 38  */
    MRE4SONST() {
        this.MRE4();
    ...
    UPTAB14() {
        if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(8355)) == -1) {
            this._internals.ST = bigdecimal_1.BigDecimal.ZERO();
        }
        else {
            if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(13470)) == -1) {
                this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(8354))).divide(bigdecimal_1.BigDecimal.valueOf(10000), 6, bigdecimal_1.BigDecimal.ROUND_DOWN);
                this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(974.58));
                ...
                if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(52882)) == -1) {
                    ...
                    this._internals.ST = (this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(971))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                }
                else {
                    if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(250731)) == -1) {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.42))).subtract(bigdecimal_1.BigDecimal.valueOf(8239))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.45))).subtract(bigdecimal_1.BigDecimal.valueOf(15761))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                }
            }
        }
    ...
    UPTAB15() {
        if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(8473)) == -1) {
            this._internals.ST = bigdecimal_1.BigDecimal.ZERO();
        }
        else {
            if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(13470)) == -1) {
                this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(8472))).divide(bigdecimal_1.BigDecimal.valueOf(10000), 6, bigdecimal_1.BigDecimal.ROUND_DOWN);
                this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(997.60));
                this._internals.RW = this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(1400));
                this._internals.ST = (this._internals.RW.multiply(this._internals.Y)).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
            }
            else {
                if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(52882)) == -1) {
                    ...
                    this._internals.RW = this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(2397));
                    this._internals.RW = this._internals.RW.multiply(this._internals.Y);
                    this._internals.ST = (this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(948.68))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                }
                else {
                    if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(250731)) == -1) {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.42))).subtract(bigdecimal_1.BigDecimal.valueOf(8261.29))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.45))).subtract(bigdecimal_1.BigDecimal.valueOf(15783.19))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                }
            }
        }
...
Lohnsteuer2015DezemberBig.TAB1 = exports.TAB1;
Lohnsteuer2015DezemberBig.TAB2 = exports.TAB2;
Lohnsteuer2015DezemberBig.TAB3 = exports.TAB3;
Lohnsteuer2015DezemberBig.TAB4 = exports.TAB4;
Lohnsteuer2015DezemberBig.TAB5 = exports.TAB5;
Lohnsteuer2015DezemberBig.ZAHL0 = exports.ZAHL0;
Lohnsteuer2015DezemberBig.ZAHL1 = exports.ZAHL1;
Lohnsteuer2015DezemberBig.ZAHL2 = exports.ZAHL2;
Lohnsteuer2015DezemberBig.ZAHL3 = exports.ZAHL3;
Lohnsteuer2015DezemberBig.ZAHL4 = exports.ZAHL4;
Lohnsteuer2015DezemberBig.ZAHL5 = exports.ZAHL5;
Lohnsteuer2015DezemberBig.ZAHL6 = exports.ZAHL6;
Lohnsteuer2015DezemberBig.ZAHL7 = exports.ZAHL7;
Lohnsteuer2015DezemberBig.ZAHL8 = exports.ZAHL8;
Lohnsteuer2015DezemberBig.ZAHL9 = exports.ZAHL9;
Lohnsteuer2015DezemberBig.ZAHL10 = exports.ZAHL10;
Lohnsteuer2015DezemberBig.ZAHL11 = exports.ZAHL11;
Lohnsteuer2015DezemberBig.ZAHL12 = exports.ZAHL12;
Lohnsteuer2015DezemberBig.ZAHL100 = exports.ZAHL100;
Lohnsteuer2015DezemberBig.ZAHL360 = exports.ZAHL360;
Lohnsteuer2015DezemberBig.ZAHL500 = exports.ZAHL500;
Lohnsteuer2015DezemberBig.ZAHL700 = exports.ZAHL700;
Lohnsteuer2015DezemberBig.ZAHL1000 = exports.ZAHL1000;
exports.Lohnsteuer2015DezemberBig = Lohnsteuer2015DezemberBig;
//# sourceMappingURL=Lohnsteuer2015Dezember.js.map