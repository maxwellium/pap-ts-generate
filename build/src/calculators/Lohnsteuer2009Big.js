...
class Lohnsteuer2009Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2009Big';
        this._inputs = {
            AJAHR: 0,
            ALTER1: 0,
    ...
    MRE4ABZ() {
        ...
        this._internals.ZRE4VP = (this._internals.ZRE4J.subtract(this._internals.FVB).subtract(this._internals.ALTE)).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
        if (this._internals.ZRE4VP.compareTo(bigdecimal_1.BigDecimal.ZERO()) == -1) {
    ...
    MZTABFB() {
        ...
        if (this._inputs.STKL == 1) {
            ...
            this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(6024))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
        }
        else {
            if (this._inputs.STKL == 2) {
                ...
                if (this._inputs.STKL == 3) {
                    ...
                    if (this._inputs.STKL == 4) {
                        this._internals.SAP = bigdecimal_1.BigDecimal.valueOf(36);
                        this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(3012))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
    ...
    UPEVP() {
        ...
        if (this._inputs.KRV > 0) {
            ...
            if (this._internals.ZRE4VP.compareTo(bigdecimal_1.BigDecimal.valueOf(64800)) == 1) {
                this._internals.ZRE4VP = bigdecimal_1.BigDecimal.valueOf(64800);
            }
            this._internals.VSP1 = (this._internals.ZRE4VP.multiply(bigdecimal_1.BigDecimal.valueOf(0.36))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
        ...
        this._internals.VSP2 = (this._internals.ZRE4VP.multiply(bigdecimal_1.BigDecimal.valueOf(0.11))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
        this._internals.VHB = (bigdecimal_1.BigDecimal.valueOf(this._internals.KZTAB).multiply(bigdecimal_1.BigDecimal.valueOf(1500))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
    ...
    MVSP() {
        this._internals.VSPO = (this._internals.ZRE4VP.multiply(bigdecimal_1.BigDecimal.valueOf(0.2))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
        this._internals.VSPVOR = (bigdecimal_1.BigDecimal.valueOf(this._internals.KZTAB).multiply(bigdecimal_1.BigDecimal.valueOf(3068))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
    ...
    MST5_6() {
        ...
        if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(26276)) == 1) {
            this._internals.ZX = bigdecimal_1.BigDecimal.valueOf(26276);
            this.UP5_6();
            if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(200320)) == 1) {
                this._internals.ST = (this._internals.ST.add((bigdecimal_1.BigDecimal.valueOf(200320).subtract(bigdecimal_1.BigDecimal.valueOf(26276))).multiply(bigdecimal_1.BigDecimal.valueOf(0.42)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                this._internals.ST = (this._internals.ST.add((this._internals.ZZX.subtract(bigdecimal_1.BigDecimal.valueOf(200320))).multiply(bigdecimal_1.BigDecimal.valueOf(0.45)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
            }
            else {
                this._internals.ST = (this._internals.ST.add((this._internals.ZZX.subtract(bigdecimal_1.BigDecimal.valueOf(26276))).multiply(bigdecimal_1.BigDecimal.valueOf(0.42)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
            }
        }
        else {
            this._internals.ZX = this._internals.ZZX;
            this.UP5_6();
            if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(9225)) == 1) {
                this._internals.VERGL = this._internals.ST;
                this._internals.ZX = bigdecimal_1.BigDecimal.valueOf(9225);
                this.UP5_6();
                this._internals.HOCH = (this._internals.ST.add((this._internals.ZZX.subtract(bigdecimal_1.BigDecimal.valueOf(9225))).multiply(bigdecimal_1.BigDecimal.valueOf(0.42)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
    ...
    UPTAB09() {
        if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(7835)) == -1) {
            this._internals.ST = bigdecimal_1.BigDecimal.ZERO();
        }
        else {
            if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(13140)) == -1) {
                this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(7834))).divide(bigdecimal_1.BigDecimal.valueOf(10000), 6, bigdecimal_1.BigDecimal.ROUND_DOWN);
                this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(939.68));
                ...
                if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(52552)) == -1) {
                    this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(13139))).divide(bigdecimal_1.BigDecimal.valueOf(10000), 6, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    ...
                    this._internals.ST = (this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(1007))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                }
                else {
                    if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(250401)) == -1) {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.42))).subtract(bigdecimal_1.BigDecimal.valueOf(8064))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.45))).subtract(bigdecimal_1.BigDecimal.valueOf(15576))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                }
            }
        }
...
Lohnsteuer2009Big.TAB1 = exports.TAB1;
Lohnsteuer2009Big.TAB2 = exports.TAB2;
Lohnsteuer2009Big.TAB3 = exports.TAB3;
Lohnsteuer2009Big.TAB4 = exports.TAB4;
Lohnsteuer2009Big.TAB5 = exports.TAB5;
Lohnsteuer2009Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2009Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2009Big.ZAHL3 = exports.ZAHL3;
Lohnsteuer2009Big.ZAHL4 = exports.ZAHL4;
Lohnsteuer2009Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2009Big.ZAHL6 = exports.ZAHL6;
Lohnsteuer2009Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2009Big.ZAHL8 = exports.ZAHL8;
Lohnsteuer2009Big.ZAHL9 = exports.ZAHL9;
Lohnsteuer2009Big.ZAHL10 = exports.ZAHL10;
Lohnsteuer2009Big.ZAHL11 = exports.ZAHL11;
Lohnsteuer2009Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2009Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2009Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2009Big.ZAHL500 = exports.ZAHL500;
Lohnsteuer2009Big.ZAHL700 = exports.ZAHL700;
