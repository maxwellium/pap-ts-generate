...
/**  Neuer Wert  2014  */
exports.RENTBEMESSUNGSGR_OST = new bigdecimal_1.BigDecimal(60000);
/**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
/**  Neuer Wert 2014  */
exports.RENTBEMESSUNGSGR_WEST = new bigdecimal_1.BigDecimal(71400);
class Lohnsteuer2014Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2014Big';
        this._inputs = {
            af: 1.0,
            AJAHR: 0,
            ALTER1: 0,
    ...
    UPEVP() {
        if (this._inputs.KRV > 1) {
            ...
            if (this._inputs.KRV == 0) {
                ...
                if (this._internals.ZRE4VP.compareTo(exports.RENTBEMESSUNGSGR_OST) == 1) {
                    this._internals.ZRE4VP = exports.RENTBEMESSUNGSGR_OST;
                }
            }
            /**  Neuer Wert 2014  */
            this._internals.VSP1 = (this._internals.ZRE4VP.multiply(bigdecimal_1.BigDecimal.valueOf(0.56))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
    ...
    MVSP() {
        /**  Neuer Wert 2014  */
        if (this._internals.ZRE4VP.compareTo(bigdecimal_1.BigDecimal.valueOf(48600)) == 1) {
            /**  Neuer Wert 2014  */
            this._internals.ZRE4VP = bigdecimal_1.BigDecimal.valueOf(48600);
        }
        if (this._inputs.PKV > 0) {
            if (this._inputs.STKL == 6) {
    ...
    MST5_6() {
        ...
        if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(26441)) == 1) {
            ...
            this.UP5_6();
            if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(9763)) == 1) { /**  Neuer Wert 2014  */
                this._internals.VERGL = this._internals.ST;
                this._internals.ZX = bigdecimal_1.BigDecimal.valueOf(9763); /**  Neuer Wert 2014  */
                this.UP5_6();
    ...
    /**  Neu 2014  */
    UPTAB14() {
        if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(8355)) == -1) { /**  Neuer Wert 2014  */
            this._internals.ST = bigdecimal_1.BigDecimal.ZERO();
        }
        else {
            if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(13470)) == -1) {
                this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(8354))).divide(bigdecimal_1.BigDecimal.valueOf(10000), 6, bigdecimal_1.BigDecimal.ROUND_DOWN); /**  Neuer Wert 2014  */
                this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(974.58)); /**  Neuer Wert 2014  */
                ...
                if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(52882)) == -1) {
                    ...
                    this._internals.ST = (this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(971))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN); /**  Neuer Wert 2014  */
                }
                else {
...
Lohnsteuer2014Big.TAB1 = exports.TAB1;
Lohnsteuer2014Big.TAB2 = exports.TAB2;
Lohnsteuer2014Big.TAB3 = exports.TAB3;
Lohnsteuer2014Big.TAB4 = exports.TAB4;
Lohnsteuer2014Big.TAB5 = exports.TAB5;
Lohnsteuer2014Big.ZAHL0 = exports.ZAHL0;
Lohnsteuer2014Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2014Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2014Big.ZAHL3 = exports.ZAHL3;
Lohnsteuer2014Big.ZAHL4 = exports.ZAHL4;
Lohnsteuer2014Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2014Big.ZAHL6 = exports.ZAHL6;
Lohnsteuer2014Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2014Big.ZAHL8 = exports.ZAHL8;
Lohnsteuer2014Big.ZAHL9 = exports.ZAHL9;
Lohnsteuer2014Big.ZAHL10 = exports.ZAHL10;
Lohnsteuer2014Big.ZAHL11 = exports.ZAHL11;
Lohnsteuer2014Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2014Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2014Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2014Big.ZAHL500 = exports.ZAHL500;
Lohnsteuer2014Big.ZAHL700 = exports.ZAHL700;
Lohnsteuer2014Big.ZAHL1000 = exports.ZAHL1000;
Lohnsteuer2014Big.RENTBEMESSUNGSGR_OST = exports.RENTBEMESSUNGSGR_OST;
Lohnsteuer2014Big.RENTBEMESSUNGSGR_WEST = exports.RENTBEMESSUNGSGR_WEST;
exports.Lohnsteuer2014Big = Lohnsteuer2014Big;
//# sourceMappingURL=Lohnsteuer2014.js.map