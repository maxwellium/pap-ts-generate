...
class Lohnsteuer2019Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2019Big';
        this._inputs = {
            af: 1,
            AJAHR: 0,
            ALTER1: 0,
        ...
        this._internals = {
            ...
            bd: new bigdecimal_1.BigDecimal(0),
    ...
    MPARA() {
        if (this._inputs.KRV < 2) { /**  &lt; = <  */
            if (this._inputs.KRV == 0) {
                this._internals.BBGRV = new bigdecimal_1.BigDecimal(80400); /**  Neu 2019  */
            }
            else {
                this._internals.BBGRV = new bigdecimal_1.BigDecimal(73800); /**  Neu 2019  */
            }
            this._internals.RVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.093); /**  Neu 2019  */
            this._internals.TBSVORV = bigdecimal_1.BigDecimal.valueOf(0.76); /**  Neu 2019  */
        }
        else {
            /**  Nichts zu tun  */
        }
        this._internals.BBGKVPV = new bigdecimal_1.BigDecimal(54450); /**  Neu 2019  */
        this._internals.bd = new bigdecimal_1.BigDecimal(2); /**  Neu 2019  */
        this._internals.KVSATZAN = (this._inputs.KVZ.divide(this._internals.bd).divide(exports.ZAHL100)).add(bigdecimal_1.BigDecimal.valueOf(0.07)); /**  Neu 2019  */
        this._internals.KVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.0045 + 0.07); /**  Neu 2019  */
        if (this._inputs.PVS == 1) {
            this._internals.PVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.02025); /**  Neu 2019  */
            this._internals.PVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.01025); /**  Neu 2019  */
        }
        else {
            this._internals.PVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.01525); /**  Neu 2019  */
            this._internals.PVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.01525); /**  Neu 2019  */
        }
        if (this._inputs.PVZ == 1) {
            this._internals.PVSATZAN = this._internals.PVSATZAN.add(bigdecimal_1.BigDecimal.valueOf(0.0025));
        }
        /**  Anfang Neu 2019  */
        this._internals.W1STKL5 = new bigdecimal_1.BigDecimal(10635);
        this._internals.W2STKL5 = new bigdecimal_1.BigDecimal(27980);
        this._internals.W3STKL5 = new bigdecimal_1.BigDecimal(212261);
        this._internals.GFB = new bigdecimal_1.BigDecimal(9168);
        /**  Ende Neu 2019  */
    ...
    MZTABFB() {
        ...
        if (this._inputs.STKL == 1) {
            ...
            this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(7620))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN); /**  Neu 2019  */
        }
        else {
            if (this._inputs.STKL == 2) {
                ...
                if (this._inputs.STKL == 3) {
                    ...
                    if (this._inputs.STKL == 4) {
                        this._internals.SAP = bigdecimal_1.BigDecimal.valueOf(36);
                        this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(3810))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN); /**  Neu 2019  */
                    }
                    else {
    ...
    UPTAB19() {
        if (this._internals.X.compareTo(this._internals.GFB.add(exports.ZAHL1)) == -1) {
            ...
            if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(14255)) == -1) {
                ...
                this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(980.14));
                ...
                if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(55961)) == -1) {
                    this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(14254))).divide(exports.ZAHL10000, 6, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(216.16));
                    ...
                    this._internals.ST = (this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(965.58))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                }
                else {
                    if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(265327)) == -1) {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.42))).subtract(bigdecimal_1.BigDecimal.valueOf(8780.9))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.45))).subtract(bigdecimal_1.BigDecimal.valueOf(16740.68))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                }
            }
        }
...
Lohnsteuer2019Big.TAB1 = exports.TAB1;
Lohnsteuer2019Big.TAB2 = exports.TAB2;
Lohnsteuer2019Big.TAB3 = exports.TAB3;
Lohnsteuer2019Big.TAB4 = exports.TAB4;
Lohnsteuer2019Big.TAB5 = exports.TAB5;
Lohnsteuer2019Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2019Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2019Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2019Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2019Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2019Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2019Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2019Big.ZAHL500 = exports.ZAHL500;
Lohnsteuer2019Big.ZAHL700 = exports.ZAHL700;
Lohnsteuer2019Big.ZAHL1000 = exports.ZAHL1000;
Lohnsteuer2019Big.ZAHL10000 = exports.ZAHL10000;
exports.Lohnsteuer2019Big = Lohnsteuer2019Big;
//# sourceMappingURL=Lohnsteuer2019.js.map