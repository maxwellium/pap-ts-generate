...
class Lohnsteuer2018Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2018Big';
        this._inputs = {
            af: 1,
            AJAHR: 0,
            ALTER1: 0,
    ...
    MPARA() {
        if (this._inputs.KRV < 2) { /**  &lt; = <  */
            if (this._inputs.KRV == 0) {
                this._internals.BBGRV = new bigdecimal_1.BigDecimal(78000); /**  Neu 2018  */
            }
            else {
                this._internals.BBGRV = new bigdecimal_1.BigDecimal(69600); /**  Neu 2018  */
            }
            this._internals.RVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.093); /**  Neu 2018  */
            this._internals.TBSVORV = bigdecimal_1.BigDecimal.valueOf(0.72); /**  Neu 2018  */
        }
        else {
            /**  Nichts zu tun  */
        }
        this._internals.BBGKVPV = new bigdecimal_1.BigDecimal(53100); /**  Neu 2018  */
        ...
        if (this._inputs.PVS == 1) {
            this._internals.PVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.01775);
            this._internals.PVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.00775);
        }
        else {
            this._internals.PVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.01275);
            this._internals.PVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.01275);
        }
        if (this._inputs.PVZ == 1) {
            this._internals.PVSATZAN = this._internals.PVSATZAN.add(bigdecimal_1.BigDecimal.valueOf(0.0025));
        }
        /**  Anfang Neu 2018  */
        this._internals.W1STKL5 = new bigdecimal_1.BigDecimal(10440);
        this._internals.W2STKL5 = new bigdecimal_1.BigDecimal(27475);
        this._internals.W3STKL5 = new bigdecimal_1.BigDecimal(208426);
        this._internals.GFB = new bigdecimal_1.BigDecimal(9000);
        /**  Ende Neu 2018  */
    ...
    MZTABFB() {
        ...
        if (this._inputs.STKL == 1) {
            ...
            this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(7428))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
        }
        else {
            if (this._inputs.STKL == 2) {
                ...
                if (this._inputs.STKL == 3) {
                    ...
                    if (this._inputs.STKL == 4) {
                        this._internals.SAP = bigdecimal_1.BigDecimal.valueOf(36);
                        this._internals.KFB = (this._inputs.ZKF.multiply(bigdecimal_1.BigDecimal.valueOf(3714))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
    ...
    MST5_6() {
        ...
        if (this._internals.ZZX.compareTo(this._internals.W2STKL5) == 1) {
            ...
            if (this._internals.ZZX.compareTo(this._internals.W1STKL5) == 1) {
                ...
                this.UP5_6();
                this._internals.HOCH = (this._internals.ST.add((this._internals.ZZX.subtract(this._internals.W1STKL5)).multiply(bigdecimal_1.BigDecimal.valueOf(0.42)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
    ...
    UPTAB18() {
        if (this._internals.X.compareTo(this._internals.GFB.add(exports.ZAHL1)) == -1) {
            ...
            if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(13997)) == -1) {
                ...
                this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(997.8));
                ...
                if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(54950)) == -1) {
                    this._internals.Y = (this._internals.X.subtract(bigdecimal_1.BigDecimal.valueOf(13996))).divide(exports.ZAHL10000, 6, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    this._internals.RW = this._internals.Y.multiply(bigdecimal_1.BigDecimal.valueOf(220.13));
                    ...
                    this._internals.ST = (this._internals.RW.add(bigdecimal_1.BigDecimal.valueOf(948.49))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                }
                else {
                    if (this._internals.X.compareTo(bigdecimal_1.BigDecimal.valueOf(260533)) == -1) {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.42))).subtract(bigdecimal_1.BigDecimal.valueOf(8621.75))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                    else {
                        this._internals.ST = ((this._internals.X.multiply(bigdecimal_1.BigDecimal.valueOf(0.45))).subtract(bigdecimal_1.BigDecimal.valueOf(16437.7))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN);
                    }
                }
            }
        }
...
Lohnsteuer2018Big.TAB1 = exports.TAB1;
Lohnsteuer2018Big.TAB2 = exports.TAB2;
Lohnsteuer2018Big.TAB3 = exports.TAB3;
Lohnsteuer2018Big.TAB4 = exports.TAB4;
Lohnsteuer2018Big.TAB5 = exports.TAB5;
Lohnsteuer2018Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2018Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2018Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2018Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2018Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2018Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2018Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2018Big.ZAHL500 = exports.ZAHL500;
Lohnsteuer2018Big.ZAHL700 = exports.ZAHL700;
Lohnsteuer2018Big.ZAHL1000 = exports.ZAHL1000;
Lohnsteuer2018Big.ZAHL10000 = exports.ZAHL10000;
exports.Lohnsteuer2018Big = Lohnsteuer2018Big;
//# sourceMappingURL=Lohnsteuer2018.js.map