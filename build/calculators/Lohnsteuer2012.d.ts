...
export declare const RENTBEMESSUNGSGR_OST_2012: BigDecimal;
/**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
export declare const RENTBEMESSUNGSGR_WEST: BigDecimal;
export declare class Lohnsteuer2012Big extends PAPBaseClass<Inputs, Outputs, Internals> {
    ...
    static readonly RENTBEMESSUNGSGR_OST_2012: BigDecimal;
