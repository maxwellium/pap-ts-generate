...
/**  Neuer Wert  2013  */
export declare const RENTBEMESSUNGSGR_OST_2013: BigDecimal;
/**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
/**  Neuer Wert 2013  */
export declare const RENTBEMESSUNGSGR_WEST: BigDecimal;
export declare class Lohnsteuer2013Big extends PAPBaseClass<Inputs, Outputs, Internals> {
    ...
    static readonly RENTBEMESSUNGSGR_OST_2013: BigDecimal;
    static readonly RENTBEMESSUNGSGR_WEST: BigDecimal;
    name: string;
    _inputs: {
        af: number;
        AJAHR: number;
