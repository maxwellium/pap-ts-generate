...
class Lohnsteuer2015Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2015Big';
        this._inputs = {
            af: 1.0,
            AJAHR: 0,
            ALTER1: 0,
    ...
    /**  Neu 2015  */
    /**  Zuweisung von Werten this._inputs.für bestimmte Sozialversicherungsparameter  PAP Seite 13  */
    MPARA() {
    ...
    /**  Ermittlung des Jahresarbeitslohns nach § 39 b Abs. 2 Satz 2 EStG, PAP Seite 14  */
    MRE4JL() {
    ...
    /**  Freibeträge this._inputs.für Versorgungsbezüge, Altersentlastungsbetrag (§ 39b Abs. 2 Satz 3 EStG), PAP Seite 15  */
    MRE4() {
    ...
    /**  Altersentlastungsbetrag (§ 39b Abs. 2 Satz 3 EStG), PAP Seite 16  */
    MRE4ALTE() {
    ...
    /**  Ermittlung des Jahresarbeitslohns nach Abzug der Freibeträge nach § 39 b Abs. 2 Satz 3 und 4 EStG, PAP Seite 18  */
    MRE4ABZ() {
    ...
    /**  Ermittlung der festen Tabellenfreibeträge (ohne Vorsorgepauschale), PAP Seite 19  */
    MZTABFB() {
    ...
    /**  Ermittlung Jahreslohnsteuer, PAP Seite 20  */
    MLSTJAHR() {
        this.UPEVP();
    ...
    /**  Ermittlung der Jahreslohnsteuer aus dem Einkommensteuertarif. PAP Seite 22  */
    UPMLST() {
    ...
    /**  Achtung !!! Komplett Neu 2015  */
    /**  Vorsorgepauschale (§39b Abs. 2 Satz 5 Nr 3 EStG) Vergleichsberechnung fuer Guenstigerpruefung, PAP Seite 24  */
    MVSP() {
    ...
    /**  Lohnsteuer fuer die Steuerklassen V und VI (§ 39b Abs. 2 Satz 7 EStG), PAP Seite 25  */
    MST5_6() {
        ...
        if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(26441)) == 1) {
            ...
            this.UP5_6();
            if (this._internals.ZZX.compareTo(bigdecimal_1.BigDecimal.valueOf(9763)) == 1) {
                this._internals.VERGL = this._internals.ST;
                this._internals.ZX = bigdecimal_1.BigDecimal.valueOf(9763);
                this.UP5_6();
                this._internals.HOCH = (this._internals.ST.add((this._internals.ZZX.subtract(bigdecimal_1.BigDecimal.valueOf(9763))).multiply(bigdecimal_1.BigDecimal.valueOf(0.42)))).setScale(0, bigdecimal_1.BigDecimal.ROUND_DOWN); /**  Neuer Wert 2014  */
    ...
    /**  Unterprogramm zur Lohnsteuer fuer die Steuerklassen V und VI (§ 39b Abs. 2 Satz 7 EStG), PAP Seite 26  */
    UP5_6() {
    ...
    /**  Solidaritaetszuschlag, PAP Seite 27  */
    MSOLZ() {
    ...
    /**  Anteil von Jahresbetraegen fuer einen this._inputs.LZZ (§ 39b Abs. 2 Satz 9 EStG), PAP Seite 28  */
    UPANTEIL() {
        if (this._inputs.LZZ == 1) {
    ...
    /**  Berechnung sonstiger Bezuege nach § 39b Abs. 3 Saetze 1 bis 8 EStG), PAP Seite 29  */
    MSONST() {
        this._inputs.LZZ = 1;
    ...
    /**  Berechnung der Verguetung fuer mehrjaehrige Taetigkeit nach § 39b Abs. 3 Satz 9 und 10 EStG), PAP Seite 30  */
    MVMT() {
    ...
    /**  Sonderberechnung ohne sonstige Bezüge this._inputs.für Berechnung bei sonstigen Bezügen oder Vergütung this._inputs.für mehrjährige Tätigkeit, PAP Seite 31  */
    MOSONST() {
...
Lohnsteuer2015Big.TAB1 = exports.TAB1;
Lohnsteuer2015Big.TAB2 = exports.TAB2;
Lohnsteuer2015Big.TAB3 = exports.TAB3;
Lohnsteuer2015Big.TAB4 = exports.TAB4;
Lohnsteuer2015Big.TAB5 = exports.TAB5;
Lohnsteuer2015Big.ZAHL0 = exports.ZAHL0;
Lohnsteuer2015Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2015Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2015Big.ZAHL3 = exports.ZAHL3;
Lohnsteuer2015Big.ZAHL4 = exports.ZAHL4;
Lohnsteuer2015Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2015Big.ZAHL6 = exports.ZAHL6;
Lohnsteuer2015Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2015Big.ZAHL8 = exports.ZAHL8;
Lohnsteuer2015Big.ZAHL9 = exports.ZAHL9;
Lohnsteuer2015Big.ZAHL10 = exports.ZAHL10;
Lohnsteuer2015Big.ZAHL11 = exports.ZAHL11;
Lohnsteuer2015Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2015Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2015Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2015Big.ZAHL500 = exports.ZAHL500;
Lohnsteuer2015Big.ZAHL700 = exports.ZAHL700;
Lohnsteuer2015Big.ZAHL1000 = exports.ZAHL1000;
exports.Lohnsteuer2015Big = Lohnsteuer2015Big;
//# sourceMappingURL=Lohnsteuer2015BisNovember.js.map