...
/**  Neuer Wert  2014  */
export declare const RENTBEMESSUNGSGR_OST: BigDecimal;
/**  Rentenbemessungs-Grenze alte Bundesländer in EUR  */
/**  Neuer Wert 2014  */
export declare const RENTBEMESSUNGSGR_WEST: BigDecimal;
export declare class Lohnsteuer2014Big extends PAPBaseClass<Inputs, Outputs, Internals> {
    ...
    static readonly RENTBEMESSUNGSGR_OST: BigDecimal;
