...
class Lohnsteuer2010Big extends PAPBaseClass_1.PAPBaseClass {
    constructor() {
        super(...arguments);
        this.name = 'Lohnsteuer2010Big';
        this._inputs = {
            AF: 0,
            AJAHR: 0,
            ALTER1: 0,
        ...
        this._internals = {
            ...
            KVSATZAG: new bigdecimal_1.BigDecimal(0).setScale(5),
            KVSATZAN: new bigdecimal_1.BigDecimal(0).setScale(5),
            KZTAB: 0,
            ...
            PVSATZAG: new bigdecimal_1.BigDecimal(0).setScale(5),
            PVSATZAN: new bigdecimal_1.BigDecimal(0).setScale(5),
    ...
    UPEVP() {
        if (this._inputs.KRV > 1) {
            ...
            if (this._inputs.KRV == 0) {
                ...
                if (this._internals.ZRE4VP.compareTo(bigdecimal_1.BigDecimal.valueOf(55800)) == 1) {
                    this._internals.ZRE4VP = bigdecimal_1.BigDecimal.valueOf(55800);
                }
            }
            this._internals.VSP1 = (this._internals.ZRE4VP.multiply(bigdecimal_1.BigDecimal.valueOf(0.4))).setScale(2, bigdecimal_1.BigDecimal.ROUND_DOWN);
    ...
    MVSP() {
        if (this._internals.ZRE4VP.compareTo(bigdecimal_1.BigDecimal.valueOf(45000)) == 1) {
            this._internals.ZRE4VP = bigdecimal_1.BigDecimal.valueOf(45000);
        }
        if (this._inputs.PKV > 0) {
            if (this._inputs.STKL == 6) {
                ...
                if (this._inputs.PKV == 2) {
                    this._internals.KVSATZAG = bigdecimal_1.BigDecimal.valueOf(0.067).setScale(5);
            ...
            this._internals.KVSATZAN = bigdecimal_1.BigDecimal.valueOf(0.076).setScale(5);
            if (this._inputs.PVS == 1) {
...
Lohnsteuer2010Big.TAB1 = exports.TAB1;
Lohnsteuer2010Big.TAB2 = exports.TAB2;
Lohnsteuer2010Big.TAB3 = exports.TAB3;
Lohnsteuer2010Big.TAB4 = exports.TAB4;
Lohnsteuer2010Big.TAB5 = exports.TAB5;
Lohnsteuer2010Big.ZAHL1 = exports.ZAHL1;
Lohnsteuer2010Big.ZAHL2 = exports.ZAHL2;
Lohnsteuer2010Big.ZAHL3 = exports.ZAHL3;
Lohnsteuer2010Big.ZAHL4 = exports.ZAHL4;
Lohnsteuer2010Big.ZAHL5 = exports.ZAHL5;
Lohnsteuer2010Big.ZAHL6 = exports.ZAHL6;
Lohnsteuer2010Big.ZAHL7 = exports.ZAHL7;
Lohnsteuer2010Big.ZAHL8 = exports.ZAHL8;
Lohnsteuer2010Big.ZAHL9 = exports.ZAHL9;
Lohnsteuer2010Big.ZAHL10 = exports.ZAHL10;
Lohnsteuer2010Big.ZAHL11 = exports.ZAHL11;
Lohnsteuer2010Big.ZAHL12 = exports.ZAHL12;
Lohnsteuer2010Big.ZAHL100 = exports.ZAHL100;
Lohnsteuer2010Big.ZAHL360 = exports.ZAHL360;
Lohnsteuer2010Big.ZAHL500 = exports.ZAHL500;
Lohnsteuer2010Big.ZAHL700 = exports.ZAHL700;
exports.Lohnsteuer2010Big = Lohnsteuer2010Big;
//# sourceMappingURL=Lohnsteuer2010Big.js.map